...
def test_curated_pdfs_use_single_pagebreak_helper_before_model_sections() -> None:
    ...
    assert "should_render_highlight_model_description(inputs, model_id)" in mainstream_text
    ...
    assert "should_render_highlight_model_description(inputs, model_id)" in non_mainstream_text
