...
def test_daily_volume_breakout_operation_section_adds_active_empty_rows() -> None:
    ...
    out = builder.normalize_source_rows(source, "ready", "20260612", 3, "2026-06-15 12:00:00 Asia/Taipei")
...
def test_daily_volume_breakout_operation_section_ignores_other_models() -> None:
    ...
    out = builder.normalize_source_rows(source, "ready", "20260612", 0, "2026-06-15 12:00:00 Asia/Taipei")
