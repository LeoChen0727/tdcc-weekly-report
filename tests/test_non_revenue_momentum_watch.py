...
import validate_daily_market_report as daily_validator  # noqa: E402
...
def test_daily_market_validator_allows_legacy_empty_non_revenue_momentum_csv(tmp_path, monkeypatch) -> None:
    empty_csv = tmp_path / "non_revenue_momentum_watch_latest.csv"
    empty_csv.write_text("", encoding="utf-8")
    monkeypatch.setattr(daily_validator, "NON_REVENUE_MOMENTUM_CSV", empty_csv)

    errors: list[str] = []
    daily_validator.check_non_revenue_momentum_section("", "", errors)
