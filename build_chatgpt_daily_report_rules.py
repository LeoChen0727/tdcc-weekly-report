...
- Key fields include theme_strength_score, catalyst_strength_score, catalyst_tags, fundamental_catalyst_score, fundamental_catalyst_tags, event_catalyst_tags, price_reaction_level, similar_to_shihsinko_flag, revenue_good_eps_unconfirmed_flag, low_reaction_after_catalyst, and already_reacted_to_catalyst.
- Read theme_event_calendar_raw_url, company_theme_mapping_raw_url, quarterly_catalyst_raw_url, event_catalyst_log_raw_url, catalyst_summary_raw_url, and catalyst_performance_raw_url when available.
