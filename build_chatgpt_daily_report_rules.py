...
- The fixed six categories are the core model buckets. They are not a ban on program-side specialty sections.
- Theme status, TDCC edge, warrant status, volume attack, non-revenue momentum, short-term D+5/D+10 edge, and backtest research rows are overlay tags or specialty sections unless the program-side schema explicitly makes them core categories.
