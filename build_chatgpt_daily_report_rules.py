...
- For `weekly_surge_strict_parameter_search_latest.md/csv`, do not write `週線急漲`, `周線急漲嚴格參數`, `最佳歷史D+5勝率`, or `最佳歷史D+10勝率`. Display it as `隔日開盤後 D+1 至 D+10 盤中觸及 +10% 研究`.
...
- First-page table columns must include: model/category, stock, model rank/display rank, model_score, score_components or why_selected_zh, and risk/next confirmation from risk_tags_zh/risk_penalty_tags/next_confirmation_zh.
