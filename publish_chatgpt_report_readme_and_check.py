...
WEEKLY_SURGE_MULTIFACTOR_GRID_CSV = LATEST_DIR / "weekly_surge_multifactor_filter_grid_latest.csv"
...
DAILY_MODEL_PARAMETER_RESEARCH_CSV = LATEST_DIR / "daily_model_parameter_research_latest.csv"
DAILY_MODEL_PARAMETER_RESEARCH_MD = LATEST_DIR / "daily_model_parameter_research_latest.md"
DAILY_MODEL_PARAMETER_RESEARCH_DETAIL_CSV = LATEST_DIR / "daily_model_parameter_research_horizon_detail_latest.csv"
DAILY_MODEL_PARAMETER_RESEARCH_DETAIL_MD = LATEST_DIR / "daily_model_parameter_research_horizon_detail_latest.md"
DAILY_MODEL_PARAMETER_RECOMMENDATIONS_CSV = LATEST_DIR / "daily_model_parameter_recommendations_latest.csv"
DAILY_MODEL_PARAMETER_RECOMMENDATIONS_MD = LATEST_DIR / "daily_model_parameter_recommendations_latest.md"
...
INDIVIDUAL_STOCK_AVAILABLE_RAW_DATA_INDEX_CSV = INDIVIDUAL_STOCK_REPORTS_DIR / "individual_stock_available_raw_data_index.csv"
INDIVIDUAL_STOCK_AVAILABLE_RAW_DATA_INDEX_MD = INDIVIDUAL_STOCK_REPORTS_DIR / "individual_stock_available_raw_data_index.md"
INDIVIDUAL_STOCK_AVAILABLE_RAW_DATA_INDEX_SLIM_CSV = INDIVIDUAL_STOCK_REPORTS_DIR / "individual_stock_available_raw_data_index_slim.csv"
INDIVIDUAL_STOCK_AVAILABLE_RAW_DATA_INDEX_SLIM_MD = INDIVIDUAL_STOCK_REPORTS_DIR / "individual_stock_available_raw_data_index_slim.md"
INDIVIDUAL_STOCK_READ_PROTOCOL_MD = INDIVIDUAL_STOCK_REPORTS_DIR / "individual_stock_read_protocol_latest.md"
INDIVIDUAL_STOCK_REPORTS_INDEX_CSV = INDIVIDUAL_STOCK_REPORTS_DIR / "individual_stock_reports_index.csv"
INDIVIDUAL_STOCK_REPORTS_INDEX_MD = INDIVIDUAL_STOCK_REPORTS_DIR / "individual_stock_reports_index.md"
INDIVIDUAL_STOCK_CHATGPT_PACKET_INDEX_CSV = INDIVIDUAL_STOCK_REPORTS_DIR / "individual_stock_chatgpt_packet_index.csv"
...
def build_readme(
    *,
    ...
    lines = [
        ...
        f"weekly_surge_multifactor_filter_grid_csv_raw_url={raw_url('main', WEEKLY_SURGE_MULTIFACTOR_GRID_CSV)}",
        ...
        f"daily_model_parameter_research_csv_raw_url={raw_url('main', DAILY_MODEL_PARAMETER_RESEARCH_CSV)}",
        f"daily_model_parameter_research_md_raw_url={raw_url('main', DAILY_MODEL_PARAMETER_RESEARCH_MD)}",
        f"daily_model_parameter_research_detail_csv_raw_url={raw_url('main', DAILY_MODEL_PARAMETER_RESEARCH_DETAIL_CSV)}",
        f"daily_model_parameter_research_detail_md_raw_url={raw_url('main', DAILY_MODEL_PARAMETER_RESEARCH_DETAIL_MD)}",
        f"daily_model_parameter_recommendations_csv_raw_url={raw_url('main', DAILY_MODEL_PARAMETER_RECOMMENDATIONS_CSV)}",
        f"daily_model_parameter_recommendations_md_raw_url={raw_url('main', DAILY_MODEL_PARAMETER_RECOMMENDATIONS_MD)}",
        f"daily_model_parameter_research_csv_pages_url={pages_url('latest/daily_model_parameter_research_latest.csv')}",
        f"daily_model_parameter_research_md_pages_url={pages_url('latest/daily_model_parameter_research_latest.md')}",
        f"daily_model_parameter_research_detail_csv_pages_url={pages_url('latest/daily_model_parameter_research_horizon_detail_latest.csv')}",
        f"daily_model_parameter_research_detail_md_pages_url={pages_url('latest/daily_model_parameter_research_horizon_detail_latest.md')}",
        f"daily_model_parameter_recommendations_csv_pages_url={pages_url('latest/daily_model_parameter_recommendations_latest.csv')}",
        f"daily_model_parameter_recommendations_md_pages_url={pages_url('latest/daily_model_parameter_recommendations_latest.md')}",
        ...
        f"market_abnormal_status_md_raw_url={raw_url('main', MARKET_ABNORMAL_STATUS_MD)}",
        f"market_abnormal_status_csv_raw_url={raw_url('main', MARKET_ABNORMAL_STATUS_CSV)}",
        ...
        f"individual_stock_available_raw_data_index_pages_url={pages_url('latest/individual_stock_reports/individual_stock_available_raw_data_index.csv')}",
        f"individual_stock_available_raw_data_index_md_pages_url={pages_url('latest/individual_stock_reports/individual_stock_available_raw_data_index.md')}",
        ...
        f"individual_stock_available_raw_data_index_slim_pages_url={pages_url('latest/individual_stock_reports/individual_stock_available_raw_data_index_slim.csv')}",
        f"individual_stock_available_raw_data_index_slim_md_pages_url={pages_url('latest/individual_stock_reports/individual_stock_available_raw_data_index_slim.md')}",
        ...
        f"individual_stock_read_protocol_pages_url={pages_url('latest/individual_stock_reports/individual_stock_read_protocol_latest.md')}",
        ...
        f"individual_stock_reports_index_pages_url={pages_url('latest/individual_stock_reports/individual_stock_reports_index.csv')}",
        f"individual_stock_reports_index_md_pages_url={pages_url('latest/individual_stock_reports/individual_stock_reports_index.md')}",
        ...
        f"individual_stock_chatgpt_packet_index_pages_url={pages_url('latest/individual_stock_reports/individual_stock_chatgpt_packet_index.csv')}",
        f"individual_stock_chatgpt_packet_index_md_pages_url={pages_url('latest/individual_stock_reports/individual_stock_chatgpt_packet_index.md')}",
...
def sync_docs_files() -> None:
    ...
    for src in [
        ...
        DAILY_MODEL_PARAMETER_RESEARCH_CSV,
        DAILY_MODEL_PARAMETER_RESEARCH_MD,
        DAILY_MODEL_PARAMETER_RESEARCH_DETAIL_CSV,
        DAILY_MODEL_PARAMETER_RESEARCH_DETAIL_MD,
    ]:
        if src.exists():
...
def main() -> int:
    ...
    publish_check_json = {
        ...
        "weekly_surge_multifactor_filter_grid_csv_raw_url": raw_url("main", WEEKLY_SURGE_MULTIFACTOR_GRID_CSV),
        ...
        "daily_model_parameter_research_csv_raw_url": raw_url("main", DAILY_MODEL_PARAMETER_RESEARCH_CSV),
        "daily_model_parameter_research_md_raw_url": raw_url("main", DAILY_MODEL_PARAMETER_RESEARCH_MD),
        "daily_model_parameter_research_detail_csv_raw_url": raw_url("main", DAILY_MODEL_PARAMETER_RESEARCH_DETAIL_CSV),
        "daily_model_parameter_research_detail_md_raw_url": raw_url("main", DAILY_MODEL_PARAMETER_RESEARCH_DETAIL_MD),
        "daily_model_parameter_recommendations_csv_raw_url": raw_url("main", DAILY_MODEL_PARAMETER_RECOMMENDATIONS_CSV),
        "daily_model_parameter_recommendations_md_raw_url": raw_url("main", DAILY_MODEL_PARAMETER_RECOMMENDATIONS_MD),
        "daily_model_parameter_research_csv_pages_url": pages_url("latest/daily_model_parameter_research_latest.csv"),
        "daily_model_parameter_research_md_pages_url": pages_url("latest/daily_model_parameter_research_latest.md"),
        "daily_model_parameter_research_detail_csv_pages_url": pages_url("latest/daily_model_parameter_research_horizon_detail_latest.csv"),
        "daily_model_parameter_research_detail_md_pages_url": pages_url("latest/daily_model_parameter_research_horizon_detail_latest.md"),
        "daily_model_parameter_recommendations_csv_pages_url": pages_url("latest/daily_model_parameter_recommendations_latest.csv"),
        "daily_model_parameter_recommendations_md_pages_url": pages_url("latest/daily_model_parameter_recommendations_latest.md"),
        ...
        "market_abnormal_status_md_raw_url": raw_url("main", MARKET_ABNORMAL_STATUS_MD),
        "market_abnormal_status_csv_raw_url": raw_url("main", MARKET_ABNORMAL_STATUS_CSV),
        ...
        "individual_stock_available_raw_data_index_pages_url": pages_url("latest/individual_stock_reports/individual_stock_available_raw_data_index.csv"),
        "individual_stock_available_raw_data_index_md_pages_url": pages_url("latest/individual_stock_reports/individual_stock_available_raw_data_index.md"),
        ...
        "individual_stock_available_raw_data_index_slim_pages_url": pages_url("latest/individual_stock_reports/individual_stock_available_raw_data_index_slim.csv"),
        "individual_stock_available_raw_data_index_slim_md_pages_url": pages_url("latest/individual_stock_reports/individual_stock_available_raw_data_index_slim.md"),
        ...
        "individual_stock_read_protocol_pages_url": pages_url("latest/individual_stock_reports/individual_stock_read_protocol_latest.md"),
        ...
        "individual_stock_reports_index_pages_url": pages_url("latest/individual_stock_reports/individual_stock_reports_index.csv"),
        "individual_stock_reports_index_md_pages_url": pages_url("latest/individual_stock_reports/individual_stock_reports_index.md"),
        ...
        "individual_stock_chatgpt_packet_index_pages_url": pages_url("latest/individual_stock_reports/individual_stock_chatgpt_packet_index.csv"),
        "individual_stock_chatgpt_packet_index_md_pages_url": pages_url("latest/individual_stock_reports/individual_stock_chatgpt_packet_index.md"),
