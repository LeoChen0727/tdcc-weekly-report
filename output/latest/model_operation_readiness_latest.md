...
- generated_at: `2026-06-29 07:48:08 Asia/Taipei`
...
| w_bottom_right_side | production_parity | approved_operation_v1 | model_header_evidence_ready | True | approved_for_daily_v1 | w_bottom_early_entry_operation_v1 | w_bottom_early_entry_operation_v1_20260629 | True | approved_daily_operation_guidance | pdf_model_header_evidence_ready | packet_model_header_evidence_ready | W-bottom early-entry operation approval is ready; pure win rate and inclusive success rate must be labeled separately | W底右低點早期進場 v1 已由 approved_operation_patterns 批准；此模型使用標題下方證據，不共用放量攻擊 operation section adapter。 |
