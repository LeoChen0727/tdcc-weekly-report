...
- Mature operation stock rows audited: `362`.
- Unique stock lifecycle rows after removing highlight/full view duplication: `181`.
- Ready row-level metrics: `200`; explicit unavailable rows: `162`.
...
| mature_model | `price_pullback_23ema` | 336 | 168 | 200 | 136 | exact_combo | pass_ready_rows_use_formal_row_metric | pass_exact_package_metric_required_for_multi_feature_technical_strength / pass_improves_win_and_avg_vs_baseline | adapter_contract_ready_pdf_packet_consumers_integrated | none |
