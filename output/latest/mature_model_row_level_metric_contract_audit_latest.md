...
- Mature operation stock rows audited: `568`.
- Unique stock lifecycle rows after removing highlight/full view duplication: `284`.
- Ready row-level metrics: `214`; explicit unavailable rows: `354`.
...
| mature_model | `price_pullback_23ema` | 500 | 250 | 202 | 298 | exact_combo | pass_ready_rows_use_formal_row_metric | pass_exact_package_metric_required_for_multi_feature_technical_strength / pass_improves_win_and_avg_vs_baseline | adapter_contract_ready_pdf_packet_consumers_integrated | none |
