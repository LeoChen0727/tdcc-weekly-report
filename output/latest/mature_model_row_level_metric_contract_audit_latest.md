...
- Mature operation stock rows audited: `680`.
- Unique stock lifecycle rows after removing highlight/full view duplication: `340`.
- Ready row-level metrics: `166`; explicit unavailable rows: `514`.
...
| --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- | --- | --- |
| mature_model | `volume_range_breakout_v2_low_position_volume_attack` | 28 | 14 | 0 | 28 | no_current_formal_row_metric | pass_explicit_unavailable_no_baseline_substitution | not_available_unvalidated_ranking_score_components / not_applicable_no_approved_combo_metric | adapter_contract_ready_pdf_packet_consumers_integrated | none |
| mature_model | `volume_range_breakout_v2_mid_position_momentum_attack` | 18 | 9 | 0 | 18 | no_current_formal_row_metric | pass_explicit_unavailable_no_baseline_substitution | not_available_unvalidated_ranking_score_components / not_applicable_no_approved_combo_metric | adapter_contract_ready_pdf_packet_consumers_integrated | none |
| mature_model | `volume_range_breakout_v2_high_position_volume_attack` | 22 | 11 | 22 | 0 | exact_combo|single_add_score | pass_ready_rows_use_formal_row_metric | pass_exact_recomputed_combo_metrics_match_research_source / pass_exact_combo_or_best_single_fallback_policy | adapter_contract_ready_pdf_packet_consumers_integrated | none |
...
| mature_model | `price_pullback_23ema` | 582 | 291 | 144 | 438 | exact_combo | pass_ready_rows_use_formal_row_metric | pass_exact_package_metric_required_for_multi_feature_technical_strength / pass_improves_win_and_avg_vs_baseline | adapter_contract_ready_pdf_packet_consumers_integrated | none |
| mature_model | `revenue_unreacted_range` | 16 | 8 | 0 | 16 | no_current_formal_row_metric | pass_explicit_unavailable_no_baseline_substitution | not_applicable_frozen_no_add_score_items / not_applicable_no_approved_combo_metric | adapter_contract_ready_pdf_packet_consumers_integrated | none |
