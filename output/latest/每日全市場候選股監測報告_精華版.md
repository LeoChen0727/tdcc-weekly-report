...
- 完整原因：近幾週其中一項大戶級距減少；no_signal；今日無可用權證成交金額；區間內轉強；量比1.72x；月營收YoY 31.8%；累計YoY 15.8%；TDCC近幾週大戶籌碼轉弱
...
- 完整原因：近幾週400張與1000張同步減少；區間內轉強；量比1.8x；月營收YoY 5.2%；累計YoY 14.9%；TDCC近幾週大戶籌碼轉弱
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
...
- 完整原因：近幾週400張與1000張同步減少；挑戰前高；量比2.76x；月營收YoY 65.6%；累計YoY 34.0%；TDCC近幾週大戶籌碼轉弱
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
...
- 完整原因：近幾週400張與1000張同步減少；區間內轉強；量比2.17x；月營收YoY 81.1%；累計YoY 58.3%；TDCC近幾週大戶籌碼轉弱
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
- 候選資料備援圖表：`output/latest/charts/range_rebound/2305_全友_range_rebound_20260523.png`
...
- 完整原因：近幾週400張與1000張同步減少；no_signal；今日無可用權證成交金額；區間內轉強；量比2.83x；月營收YoY 15.5%；累計YoY 4.5%；TDCC近幾週大戶籌碼轉弱
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
- 候選資料備援圖表：`output/latest/charts/range_rebound/2324_仁寶_range_rebound_20260523.png`
...
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
- 候選資料備援圖表：`output/latest/charts/revenue_breakout_low_response/2537_聯上發_revenue_breakout_low_response_20260523.png`
...
- 權證：
- 摘要：TDCC增加 / 大戶溫和增加
- 完整原因：近幾週400張與1000張合計增加；量比1.37x；月營收YoY 120.7%；累計YoY 79.6%；TDCC近幾週大戶溫和增加
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
...
- 權證：
- 摘要：TDCC轉弱 / 大戶轉弱
- 完整原因：近幾週400張與1000張同步減少；no_signal；今日無可用權證成交金額；量比0.98x；月營收YoY 360.8%；累計YoY 276.9%；TDCC近幾週大戶籌碼轉弱
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
- 候選資料備援圖表：`output/latest/charts/revenue_pullback/8271_宇瞻_revenue_pullback_20260523.png`
...
- 權證：
- 摘要：TDCC轉弱 / 大戶轉弱
- 完整原因：近幾週400張與1000張同步減少；no_signal；今日無可用權證成交金額；量比0.6x；月營收YoY 153.7%；累計YoY 93.5%；TDCC近幾週大戶籌碼轉弱
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
...
- 權證：
- 摘要：TDCC增加 / 大戶溫和增加
- 完整原因：近幾週400張與1000張合計增加；no_signal；今日無可用權證成交金額；量比0.92x；月營收YoY 58.4%；累計YoY 60.8%；TDCC近幾週大戶溫和增加
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
- 候選資料備援圖表：`output/latest/charts/revenue_pullback/2368_金像電_revenue_pullback_20260523.png`
