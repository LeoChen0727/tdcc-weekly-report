...
- 摘要：區間轉強 / 距前高-15.72% / 大戶轉弱 / call_put_bullish / 3.0
- 完整原因：近幾週400張與1000張同步減少；call_put_bullish；認購成交金額明顯大於認售，且認購資金明顯升溫；區間內轉強；量比2.04x；月營收YoY 13.3%；累計YoY -4.8%；TDCC近幾週大戶籌碼轉弱
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
- 候選資料備援圖表：`output/latest/charts/range_rebound/1301_台塑_range_rebound_20260531.png`

### 2324 仁寶
- 族群：電腦及週邊設備業
- 分數 / 排名：69.0 / 
- 優先級：
- 連續上榜：訊號鈍化；近5日 5；近10日 9；多分類 pattern|range_rebound
- TDCC：大戶轉弱
- 權證：call_put_bullish / 3.0
...
- 摘要：區間轉強 / 距前高-0.41% / 大戶轉弱 / call_put_bullish / 3.0
- 完整原因：近幾週400張與1000張同步減少；call_put_bullish；認購成交金額明顯大於認售，且認購資金明顯升溫；區間內轉強；量比3.33x；月營收YoY 15.5%；累計YoY 4.5%；TDCC近幾週大戶籌碼轉弱
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
- 候選資料備援圖表：`output/latest/charts/range_rebound/2324_仁寶_range_rebound_20260531.png`

### 2352 佳世達
- 族群：電腦及週邊設備業
- 分數 / 排名：69.0 / 
- 優先級：
- 連續上榜：反覆上榜未突破；近5日 5；近10日 9；多分類 pattern|range_rebound
- TDCC：大戶同步增加
- 權證：call_put_bullish / 3.0
- 財報 / 事件催化：score 0 / theme 100.0/5 / monthly_revenue_calendar;calendar_monthly_revenue_expected_window;電腦及週邊設備業 / monthly_revenue_calendar;calendar_mon...
- 摘要：區間轉強 / 距前高-1.37% / 大戶同步增加 / call_put_bullish / 3.0
- 完整原因：近幾週400張與1000張同步累積；call_put_bullish；認購成交金額明顯大於認售，且認購資金明顯升溫；區間內轉強；量比1.1x；月營收YoY -1.8%；累計YoY 2.2%；TDCC近幾週400張與1000張同步累積
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
...
- TDCC：大戶轉弱
- 權證：call_put_bullish / 3.0
- 財報 / 事件催化：score 0 / theme 57.6/5 / monthly_revenue_calendar;calendar_monthly_revenue_expected_window;其他電子業 / monthly_revenue_calendar;calendar_monthly...
- 摘要：區間轉強 / 距前高-6.74% / 大戶轉弱 / call_put_bullish / 3.0
- 完整原因：近幾週400張與1000張同步減少；call_put_bullish；認購成交金額明顯大於認售，且認購資金明顯升溫；區間內轉強；量比1.37x；月營收YoY -49.4%；累計YoY -25.8%；TDCC近幾週大戶籌碼轉弱
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
...
- 摘要：TDCC轉弱 / 大戶轉弱
- 完整原因：近幾週400張與1000張同步減少；量比1.96x；月營收YoY 65.6%；累計YoY 34.0%；TDCC近幾週大戶籌碼轉弱
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
- 候選資料備援圖表：`output/latest/charts/revenue_pullback/2241_艾姆勒_revenue_pullback_20260531.png`
...
- 財報 / 事件催化：score 0 / theme 100.0/5 / revenue_good_eps_unconfirmed;low_reaction_after_catalyst;monthly_revenue_calendar;calendar_monthly_revenue_expecte...
- 摘要：TDCC轉弱 / 大戶轉弱
- 完整原因：C_僅觀察_營建認列型需基本面確認；近幾週400張與1000張同步減少；no_signal；權證金流未見明顯高於近期平均的變化；量比0.82x；月營收YoY 52.6%；累計YoY 39.3%；TDCC近幾週大戶籌碼轉弱；營建/交屋認列型營收需基本面確認
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
- 候選資料備援圖表：`output/latest/charts/revenue_pullback/2515_中工_revenue_pullback_20260531.png`

### 3055 蔚華科
- 族群：電子通路業
- 分數 / 排名：84.0 / 
- 優先級：
- 連續上榜：訊號鈍化；近5日 5；近10日 5；多分類 pattern|revenue_pullback
- TDCC：大戶轉弱
- 權證：
- 財報 / 事件催化：score 0 / theme 100.0/5 / revenue_good_eps_unconfirmed;monthly_revenue_calendar;calendar_monthly_revenue_expected_window;電子通路業 / revenue_goo...
- 摘要：TDCC轉弱 / 大戶轉弱
- 完整原因：近幾週400張與1000張同步減少；no_signal；權證金流未見明顯高於近期平均的變化；量比0.39x；月營收YoY 336.3%；累計YoY 120.3%；TDCC近幾週大戶籌碼轉弱
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
- 候選資料備援圖表：`output/latest/charts/revenue_pullback/3055_蔚華科_revenue_pullback_20260531.png`
...
- 財報 / 事件催化：score 0 / theme 100.0/5 / revenue_good_eps_unconfirmed;low_reaction_after_catalyst;monthly_revenue_calendar;calendar_monthly_revenue_expecte...
- 摘要：TDCC轉弱 / 大戶轉弱
- 完整原因：C_僅觀察_營建認列型需基本面確認；近幾週400張與1000張同步減少；no_signal；今日無可用權證成交金額；量比1.02x；月營收YoY 264.8%；累計YoY 633.5%；TDCC近幾週大戶籌碼轉弱；營建/交屋認列型營收需基本面確認
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
- 候選資料備援圖表：`output/latest/charts/revenue_pullback/6177_達麗_revenue_pullback_20260531.png`
...
- 財報 / 事件催化：score 0 / theme 100.0/5 / revenue_good_eps_unconfirmed;low_reaction_after_catalyst;monthly_revenue_calendar;calendar_monthly_revenue_expecte...
- 摘要：TDCC轉弱 / 大戶轉弱
- 完整原因：近幾週400張與1000張同步減少；no_signal；權證金流未見明顯高於近期平均的變化；量比0.36x；月營收YoY 84.8%；累計YoY 22.4%；TDCC近幾週大戶籌碼轉弱
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
- 候選資料備援圖表：`output/latest/charts/revenue_pullback/2388_威盛_revenue_pullback_20260531.png`
...
- 分數 / 排名：54.0 / 
- 優先級：
- 連續上榜：反覆上榜未突破；近5日 5；近10日 9；多分類 pattern|revenue_pullback
- TDCC：大戶溫和增加
- 權證：call_put_bullish / 3.0
- 財報 / 事件催化：score 0 / theme 83.7/5 / monthly_revenue_calendar;calendar_monthly_revenue_expected_window;半導體業 / monthly_revenue_calendar;calendar_monthly_...
- 摘要：pattern_watch / 大戶溫和增加 / call_put_bullish / 3.0
- 完整原因：近幾週其中一項大戶級距增加；call_put_bullish；認購成交金額明顯大於認售，且認購資金明顯升溫；量比0.88x；月營收YoY 594.4%；累計YoY 419.7%；TDCC近幾週大戶溫和增加
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
- 候選資料備援圖表：`output/latest/charts/revenue_pullback/2451_創見_revenue_pullback_20260531.png`
...
- 完整原因：近幾週400張與1000張同步減少；call_put_bullish；認購成交金額明顯大於認售，且認購資金明顯升溫；量比3.95x；月營收YoY -36.2%；累計YoY -19.1%；TDCC近幾週大戶籌碼轉弱
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
...
- 完整原因：近幾週其中一項大戶級距增加；call_strong_inflow；認購權證成交金額明顯升溫；量比2.13x；月營收YoY 12.9%；累計YoY -6.2%；TDCC近幾週大戶溫和增加
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
...
- 分數 / 排名：54.0 / 
- 優先級：
- 連續上榜：訊號鈍化；近5日 5；近10日 6；多分類 pattern
- TDCC：大戶轉弱
- 權證：call_strong_inflow / 2.0
- 財報 / 事件催化：score 0 / theme 100.0/5 / monthly_revenue_calendar;calendar_monthly_revenue_expected_window;電腦及週邊設備業 / monthly_revenue_calendar;calendar_mon...
- 摘要：pattern_watch / 大戶轉弱 / call_strong_inflow / 2.0
- 完整原因：近幾週400張與1000張同步減少；call_strong_inflow；認購權證成交金額明顯升溫；量比0.98x；月營收YoY 8.3%；累計YoY 0.2%；TDCC近幾週大戶籌碼轉弱
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
