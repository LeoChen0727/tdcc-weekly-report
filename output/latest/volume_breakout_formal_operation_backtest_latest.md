...
- generated_at: `2026-07-05 04:53:07 Asia/Taipei`
...
- formal_event_rows: `3245`
- lifecycle_event_rows: `4719`

## Lifecycle State Counts

| operation_lifecycle_state | sample_maturity_status | signal_events | mature_samples |
| --- | --- | --- | --- |
| active_operation | immature_active | 77 | 0 |
| active_operation | mature | 9 | 9 |
| confirmed_operation | confirmed_not_entered | 11 | 0 |
| expired | expired_unconfirmed | 1398 | 0 |
| expired | immature_active | 36 | 0 |
| expired | mature | 3127 | 3127 |
| pending_confirmation | pending_confirmation | 61 | 0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| consecutive_accumulation | top_10 | next_day_break_signal_high_confirmed | operation_trigger | all_confirmed_volume_breakout | mature_selected_operation_only | 7 | 28.57 | -9.621 | False | low | -93.0 |
| consecutive_accumulation | top_10 | next_day_break_signal_high_confirmed | operation_price_position | high_position | mature_selected_operation_only | 7 | 28.57 | -9.621 | False | low | -93.0 |
...
| consecutive_accumulation | top_20 | next_day_break_signal_high_confirmed | operation_trigger | all_confirmed_volume_breakout | mature_selected_operation_only | 8 | 25.0 | -8.6312 | False | low | -92.0 |
| consecutive_accumulation | top_20 | next_day_break_signal_high_confirmed | operation_price_position | high_position | mature_selected_operation_only | 8 | 25.0 | -8.6312 | False | low | -92.0 |
...
| consecutive_accumulation | top_20 | next_day_break_signal_high_confirmed | operation_classification | high_position_breakout | mature_selected_operation_only | 3 | 33.33 | -7.6415 | False | low | -97.0 |
| consecutive_accumulation | top_20 | next_day_break_signal_high_confirmed | operation_attack_method | volume_attack | mature_selected_operation_only | 2 | 50.0 | 12.5449 | False | low | -98.0 |
| consecutive_accumulation | top_20 | next_day_break_signal_high_confirmed | operation_attack_position | volume_attack__high_position | mature_selected_operation_only | 2 | 50.0 | 12.5449 | False | low | -98.0 |
...
| consecutive_accumulation | top_50 | next_day_break_signal_high_confirmed | operation_trigger | all_confirmed_volume_breakout | mature_selected_operation_only | 9 | 33.33 | -7.6415 | False | low | -91.0 |
| consecutive_accumulation | top_50 | next_day_break_signal_high_confirmed | operation_price_position | high_position | mature_selected_operation_only | 9 | 33.33 | -7.6415 | False | low | -91.0 |
...
| consecutive_accumulation | top_50 | next_day_break_signal_high_confirmed | operation_classification | high_position_breakout | mature_selected_operation_only | 4 | 50.0 | 2.6447 | False | low | -96.0 |
| consecutive_accumulation | top_50 | next_day_break_signal_high_confirmed | operation_attack_method | volume_attack | mature_selected_operation_only | 3 | 66.67 | 12.931 | False | low | -97.0 |
| consecutive_accumulation | top_50 | next_day_break_signal_high_confirmed | operation_attack_position | volume_attack__high_position | mature_selected_operation_only | 3 | 66.67 | 12.931 | False | low | -97.0 |
...
| no_tdcc | all | pullback_5ma_confirmed | operation_attack_position | volume_attack__high_position | mature_selected_operation_only | 187 | 42.25 | -1.2346 | False | medium | 0.3809 |
