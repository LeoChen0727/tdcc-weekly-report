...
- generated_at: `2026-06-21 21:18:53 Asia/Taipei`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| volume_range_breakout | volume_breakout_confirmed_operation_v1 | volume_breakout_operation_v1_20260615 | True | approved_daily_operation_guidance | confirmation_next_open | signal_low_stop | signal_low_stop_or_fixed_10d_close | positive_evidence_oos_rank_v1 | 5 | 10 | 70.0 | 16.9871 | 以目前 repo 可用歷史資料批准放量攻擊 v1 操作建議。後續固定 research/backtest 可用新版 approval_version 調整參數與條件。 |
