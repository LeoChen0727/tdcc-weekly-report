...
|---|---|---:|---|---|
| twse_ex_right_ex_dividend | ok | 185 | https://www.twse.com.tw/rwd/zh/exRight/TWT48U?response=json |  |
| monthly_revenue_expected_window | rule_based_expected_window | 409 | https://mops.twse.com.tw/mops/web/t05st10_ifrs | Expected monthly revenue publication window generated for tracked stocks; not a confirmed company catalyst. |
| federal_reserve_fomc | ok | 13 | https://www.federalreserve.gov/monetarypolicy/fomccalendars.htm |  |
| bea_release_schedule | failed | 0 | https://www.bea.gov/news/schedule | HTTPSConnectionPool(host='www.bea.gov', port=443): Max retries exceeded with url: /news/schedule (Caused by NewConnectionError("HTTPSConnection(host='www.bea.gov', port=443): Failed to establish a new connection: [Errno 101] Network is unreachable")) |
