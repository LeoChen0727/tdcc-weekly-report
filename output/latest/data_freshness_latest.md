...
- 產生時間：`2026-05-21 23:24:19 Asia/Taipei`
- 主資料日期：`20260521`
- 是否可產出正式每日報告：`True`
...
| official_price_fetch_latest.md | 20260521 | 價格抓取狀態檔日期 |
| warrant_flow_latest.csv | 20260520 | 權證輔助資料日期 |
...
- warrant flow：權證資料日期落後主價格資料；權證僅作輔助欄位，不影響主報告是否可產出
