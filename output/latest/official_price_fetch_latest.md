...
- generated_at: `2026-07-07 19:27:58 Asia/Taipei`
- target_date: `20260707`
- saved_price_date: `20260707`
- is_target_date: `True`
...
- dated_csv: `data/daily_price/20260707.csv`
- dated_alt_csv: `data/daily_price/daily_price_20260707.csv`
- latest_csv: `output/latest/official_daily_price_latest.csv`

## Fetch Attempts

- 20260707: TWSE=1239 / TPEx=895 / Total=2134 / full_market_ok=True
...
- GET https://www.twse.com.tw/rwd/zh/afterTrading/MI_INDEX?date=20260707&type=ALLBUT0999&response=json -> status=200, chars=234308
...
- GET https://www.tpex.org.tw/web/stock/aftertrading/otc_quotes_no1430/stk_wn1430_result.php?l=zh-tw&o=json&d=115/07/07&se=EW -> status=200, chars=141415
...
- date=20260707 twse_rows=1239 tpex_rows=895 total_rows=2134 full_market_ok=True