...
- generated_at: `2026-06-16 05:32:35 Asia/Taipei`
...
- data_quality_note: partial_market_stale_rejected: TPEx matched previous trading day file daily_price_20260615.csv
- stale_markets: `TPEx`
- stale_market_rows: `5143`
...
- GET https://www.twse.com.tw/rwd/zh/afterTrading/MI_INDEX?date=20260616&type=ALLBUT0999&response=csv -> status=307, chars=686
...
- TWSE individual fallback start: stocks=1236 date=20260616 budget_seconds=180
...
- GET https://www.tpex.org.tw/web/stock/aftertrading/daily_close_quotes/stk_quote_result.php?l=zh-tw&o=json&d=115/06/16&s=0,asc,0 -> status=200, chars=1426584
- TPEX_OLD_DAILY_JSON: parsed TPEx JSON rows=5143
- TPEx batch selected source=TPEX_OLD_DAILY_JSON, rows=5143
- date=20260616 twse_rows=0 tpex_rows=5143 total_rows=5143 full_market_ok=False
