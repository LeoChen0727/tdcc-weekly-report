...
- generated_at: `2026-06-12 00:28:37 Asia/Taipei`
...
- 20260612: TWSE=1236 / TPEx=0 / Total=1236 / full_market_ok=False
...
- GET https://www.twse.com.tw/rwd/zh/afterTrading/MI_INDEX?date=20260612&type=ALLBUT0999&response=csv -> status=200, chars=0
- Trying TWSE batch source=TWSE_LEGACY_JSON_MI_INDEX date=20260612
- GET https://www.twse.com.tw/exchangeReport/MI_INDEX?response=json&date=20260612&type=ALLBUT0999 -> status=200, chars=25
- TWSE_LEGACY_JSON_MI_INDEX: parsed TWSE rows=0
- Trying TWSE batch source=TWSE_OPENAPI_STOCK_DAY_ALL date=20260612
- GET https://openapi.twse.com.tw/v1/exchangeReport/STOCK_DAY_ALL -> status=200, chars=309024
...
- GET https://www.tpex.org.tw/web/stock/aftertrading/daily_close_quotes/stk_quote_result.php?l=zh-tw&o=json&d=115/06/12&s=0,asc,0 -> status=200, chars=1432960
- TPEX_OLD_DAILY_JSON: parsed TPEx JSON rows=4809
- TPEx batch selected source=TPEX_OLD_DAILY_JSON, rows=4809
- date=20260612 twse_rows=1236 tpex_rows=4809 total_rows=6045 full_market_ok=True
