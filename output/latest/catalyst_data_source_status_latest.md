...
- generated_at: `2026-06-25 18:06:07 Asia/Taipei`
...
| quarterly_catalyst | `data/fundamental_catalysts/quarterly_catalyst.csv` | 820 |
| event_catalyst_log | `data/event_catalysts/event_catalyst_log.csv` | 1099 |

## External Source Status

| source | status | rows | matched_tracked_rows | url | note |
|---|---|---:|---:|---|---|
| TWSE monthly revenue OpenAPI | ok | 1082 | 257 | https://openapi.twse.com.tw/v1/opendata/t187ap05_L | Official monthly revenue rows are stored as fundamental source rows with EPS/margin fields blank. They can flag revenue_good_eps_unconfirmed only; they are not EPS confirmation. |
