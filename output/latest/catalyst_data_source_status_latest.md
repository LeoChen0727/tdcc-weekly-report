...
- generated_at: `2026-08-04 08:17:04 Asia/Taipei`
...
| event_catalyst_log | `data/event_catalysts/event_catalyst_log.csv` | 2634 |
...
| TPEX material information OpenAPI | ok | 8 | 2 | https://www.tpex.org.tw/openapi/v1/mopsfin_t187ap04_O | Official material-information rows are filtered to tracked stocks. Only objective order/customer/capacity/production/certification keywords become evidence event types; other rows stay material_information context. |
