...
| `output/latest/tdcc_dataset_manifest_latest.json` | yes | 459 |
| `output/latest/tdcc_analytics/tdcc_analytics_manifest_latest.json` | yes | 326 |
| `output/latest/tdcc_analytics/tdcc_holder_ratio_history_latest.parquet` | yes | 1054 |
| `output/latest/tdcc_analytics/tdcc_analytics_latest.duckdb` | yes | 2880 |
| `output/latest/tdcc_invalid_holder_distribution_latest.csv` | yes | 1 |
| `output/latest/tdcc_signal_performance_latest.md` | yes | 521 |
| `output/latest/tdcc_signal_structures_latest.md` | yes | 99 |
...
| `output/latest/tdcc_pre_move_abm_top_latest.md` | yes | 38 |
| `output/latest/tdcc_pre_move_abm_top_latest.csv` | yes | 27 |
| `output/latest/tdcc_phase_distribution_latest.md` | yes | 115 |
| `output/latest/tdcc_phase_distribution_latest.csv` | yes | 87 |
...
| `output/latest/tdcc_overheated_short_term_edge_candidates_latest.csv` | yes | 11 |
| `output/latest/tdcc_chatgpt_tracking_packet_latest.md` | yes | 457 |
| `output/latest/tdcc_weekly_increase_ranking_latest.md` | yes | 59 |
| `output/latest/tdcc_weekly_increase_ranking_latest.csv` | yes | 361 |
...
| `output/latest/tdcc_weekly_model_cross_summary_latest.md` | yes | 18 |
| `output/latest/tdcc_weekly_model_cross_summary_latest.csv` | yes | 10 |
| `output/latest/tdcc_weekly_report_section_manifest_latest.csv` | yes | 5 |
| `output/latest/tdcc_weekly_candidate_highlight_for_report_latest.md` | yes | 54 |
| `output/latest/tdcc_weekly_candidate_highlight_for_report_latest.csv` | yes | 30 |
| `output/latest/tdcc_weekly_candidate_full_for_report_latest.md` | yes | 97 |
| `output/latest/tdcc_weekly_candidate_full_for_report_latest.csv` | yes | 73 |
| `output/latest/tdcc_weekly_candidate_highlight_latest.md` | yes | 54 |
| `output/latest/tdcc_weekly_candidate_full_latest.md` | yes | 97 |
| `output/latest/tdcc_weekly_candidate_highlight_latest.pdf` | yes | 883 |
| `output/latest/tdcc_weekly_candidate_full_latest.pdf` | yes | 1182 |
...
| `output/history/tdcc_signals/tdcc_signal_snapshot.csv` | yes | 13724 |
| `output/history/tdcc_signals/tdcc_normalized_signal_log.csv` | yes | 13724 |
