...
- generated_at: `2026-07-08 20:01:24 Asia/Taipei`
- date: `20260708`
...
| --- | ---: | ---: | ---: | ---: | --- | --- |
| TWSE | 45,734 | -4.2% | -4.2% | -4.2% | False | True |
| TPEx | 421.39 | -7.08% | -7.08% | -7.08% | False | True |

## Combined Sentiment Interpretation

- combined_sentiment_interpretation: `insufficient_history_observe_only`
- sentiment_warning_level: `insufficient`
- foreign_tx_futures_net_oi: `-81,268`
- foreign_futures_net_oi: `-565,577` (whole futures exposure background only, not TX direction)
- put_call_oi_ratio_pct: `129.81%`
