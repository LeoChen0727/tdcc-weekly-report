...
- 產生時間：`2026-09-24 02:21:44 Asia/Taipei`
- 結果：`CONTAINED=23, DISCLOSED_NOT_INDEPENDENT=4, PASS=102`
...
| data_family_ownership | tdcc_short_term_continuation_d5_d10_research_outputs | PASS | model_owned_not_shared | none |
| data_family_ownership | tdcc_stealth_accumulation_published_signal_research_outputs | PASS | model_owned_not_shared | none |
| data_family_ownership | tdcc_stealth_accumulation_pit_replay_availability_audit | PASS | model_owned_not_shared | none |
...
| data_family_ownership | tdcc_stealth_accumulation_historical_selector_replay_outputs | PASS | model_owned_not_shared | none |
| data_family_ownership | tdcc_stealth_accumulation_field_contract_replay_outputs | PASS | model_owned_not_shared | none |
| data_family_ownership | tdcc_stealth_accumulation_price_pit_audit | PASS | model_owned_not_shared | none |
| data_family_ownership | tdcc_stealth_accumulation_operation_replay_outputs | PASS | model_owned_not_shared | none |
...
| data_family_ownership | tdcc_stealth_accumulation_condition_stratification_outputs | PASS | model_owned_not_shared | none |
| data_family_ownership | revenue_unreacted_range_source_snapshot_projection_v3_candidate | PASS | model_owned_not_shared | none |
...
| validator_independence | scripts/validate_tdcc_stealth_accumulation_historical_replay.py | PASS | independent_research_replay_validator | none |
| validator_independence | scripts/validate_tdcc_stealth_accumulation_field_contract_replay.py | PASS | independent_research_replay_validator | none |
| validator_independence | scripts/validate_tdcc_stealth_accumulation_price_pit.py | PASS | independent_source_lineage_validator | none |
| validator_independence | scripts/validate_tdcc_stealth_accumulation_operation_replay.py | PASS | independent_research_replay_validator | none |
...
| validator_independence | scripts/validate_revenue_unreacted_range_projection_v3.py | PASS | independent_research_replay_validator | none |
