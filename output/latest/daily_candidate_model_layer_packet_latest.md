...
| near_high_neckline_challenge        | 接近前高/頸線挑戰模型      | non_mainstream  |      13 |
| platform_strengthening              | 平台整理轉強模型           | mainstream      |      10 |
| platform_strengthening              | 平台整理轉強模型           | non_mainstream  |      23 |
| price_pullback_23ema                | 股價回檔模型               | mainstream      |     202 |
| price_pullback_23ema                | 股價回檔模型               | non_mainstream  |     112 |
...
| revenue_unreacted_range             | 營收爆發但股價尚未反應模型 | non_mainstream  |      61 |
...
| volume_breakout_range               | 帶量突破模型               | non_mainstream  |      20 |
