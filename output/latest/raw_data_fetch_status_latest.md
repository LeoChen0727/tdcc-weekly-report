...
- generated_at: 2026-05-25 19:27:21 Asia/Taipei
- checked_rows: 104
- success_rows: 43
- suspicious_single_line_rows: 0
- content_not_expanded_rows: 15
- cache_miss_rows: 0
...
| readme_first |  | pages | success | 200 | 106 | 1 | 106 | 112 | ok | True |
| readme_first |  | api | success | 200 | 112 | 1 | 112 | 112 | ok | True |
| readme_first |  | blob | success | 200 |  |  |  | 112 | ok | True |
| daily_report_packet |  | raw | success | 200 | 962 | 1 | 962 | 962 | ok | True |
| daily_report_packet |  | pages | success | 200 | 962 | 1 | 962 | 962 | ok | True |
| daily_report_packet |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 962 | ok | False |
| daily_report_packet |  | blob | success | 200 |  |  |  | 962 | ok | True |
| daily_market_summary |  | raw | success | 200 | 309 | 1 | 309 | 309 | ok | True |
| daily_market_summary |  | pages | missing_file | 404 | 0 | 0 | 0 | 309 | ok | False |
| daily_market_summary |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 309 | ok | False |
| daily_market_summary |  | blob | success | 200 |  |  |  | 309 | ok | True |
| daily_market_full |  | raw | success | 200 | 492 | 1 | 492 | 492 | ok | True |
| daily_market_full |  | pages | missing_file | 404 | 0 | 0 | 0 | 492 | ok | False |
| daily_market_full |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 492 | ok | False |
| daily_market_full |  | blob | success | 200 |  |  |  | 492 | ok | True |
| stock_monitor |  | raw | success | 200 | 148 | 1 | 148 | 148 | ok | True |
| stock_monitor |  | pages | missing_file | 404 | 0 | 0 | 0 | 148 | ok | False |
| stock_monitor |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 148 | ok | False |
| stock_monitor |  | blob | success | 200 |  |  |  | 148 | ok | True |
| all_candidates |  | raw | success | 200 | 458 | 205 | 459 | 459 | ok | True |
| all_candidates |  | pages | missing_file | 404 | 0 | 0 | 0 | 459 | ok | False |
| all_candidates |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 459 | ok | False |
| all_candidates |  | blob | content_not_expanded | 200 |  |  |  | 459 | ok | False |
| candidate_repeat_appearance |  | raw | success | 200 | 430 | 13 | 431 | 431 | ok | True |
| candidate_repeat_appearance |  | pages | missing_file | 404 | 0 | 0 | 0 | 431 | ok | False |
| candidate_repeat_appearance |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 431 | ok | False |
| candidate_repeat_appearance |  | blob | content_not_expanded | 200 |  |  |  | 431 | ok | False |
...
| warrant_market_report |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 197 | ok | False |
...
| warrant_flow_by_stock |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 456 | ok | False |
...
| tdcc_tracking_packet |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 661 | ok | False |
...
| tdcc_strength_ranking_top |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 51 | ok | False |
...
| tdcc_pre_move_abm_top |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 51 | ok | False |
...
| tdcc_phase_distribution |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 113 | ok | False |
...
| tdcc_top_risk_list |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 61 | ok | False |
...
| surge_model_packet |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 109 | ok | False |
...
| surge_precondition_candidates |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 101 | ok | False |
...
| surge_model_backtest |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 16 | ok | False |
...
| surge_model_feature_importance |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 11 | ok | False |
| surge_model_feature_importance |  | blob | content_not_expanded | 200 |  |  |  | 11 | ok | False |
| daily_signal_performance_summary |  | raw | success | 200 | 113 | 1 | 113 | 113 | ok | True |
| daily_signal_performance_summary |  | pages | missing_file | 404 | 0 | 0 | 0 | 113 | ok | False |
| daily_signal_performance_summary |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 113 | ok | False |
| daily_signal_performance_summary |  | blob | success | 200 |  |  |  | 113 | ok | True |
...
| individual_stock_available_raw_data_index |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 2150 | ok | False |
...
| individual_stock_reports_index |  | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 5 | ok | False |
...
| stock_price_history | 8299 | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 136 | ok | False |
| stock_price_history | 8299 | blob | content_not_expanded | 200 |  |  |  | 136 | ok | False |
...
| tdcc_stock_history | 8299 | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 5 | insufficient_tdcc_history | False |
...
| individual_stock_report_md | 8299 | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 152 | ok | False |
| individual_stock_report_md | 8299 | blob | success | 200 |  |  |  | 152 | ok | True |
...
| sell_strategy_summary | 8299 | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 28 | ok | False |
...
| sell_strategy_backtest | 8299 | api | file_exists_but_content_unreadable | 403 | 0 | 0 | 0 | 21 | ok | False |
