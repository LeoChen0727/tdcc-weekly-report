...
- generated_at: `2026-06-27 16:05:04 UTC`
...
| Warrant flow | output/latest/warrant_flow_by_stock_latest.csv | warrant_flow_signal, warrant_flow_score, warrant_flow_warning | 無明確權證訊號=373; 認購流入=42; 認購強流入=35 | Auxiliary only. Do not make warrant-only conclusions. |
