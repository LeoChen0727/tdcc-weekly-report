...
|---|---|---|---|---|---|
| 2637 | 慧洋-KY | true_breakout | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/2637_慧洋-KY_true_breakout_126d.png` | `data/daily_price` |
| 3023 | 信邦 | true_breakout | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/3023_信邦_true_breakout_126d.png` | `data/daily_price` |
...
| 2368 | 金像電 | revenue_pullback | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/2368_金像電_revenue_pullback_126d.png` | `data/daily_price` |
| 3209 | 全科 | revenue_pullback | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/3209_全科_revenue_pullback_126d.png` | `data/daily_price` |
| 6215 | 和椿 | revenue_pullback | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/6215_和椿_revenue_pullback_126d.png` | `data/daily_price` |
...
| 8996 | 高力 | revenue_pullback | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/8996_高力_revenue_pullback_126d.png` | `data/daily_price` |
| 2442 | 新美齊 | pullback_rebound | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/2442_新美齊_pullback_rebound_126d.png` | `data/daily_price` |
| 2537 | 聯上發 | pullback_rebound | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/2537_聯上發_pullback_rebound_126d.png` | `data/daily_price` |
