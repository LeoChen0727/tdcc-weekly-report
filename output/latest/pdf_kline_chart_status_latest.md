...
|---|---|---|---|---|---|
| 1773 | 勝一 | range_rebound | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/1773_勝一_range_rebound_180d.png` | `data/daily_price` |
| 2236 | 百達-KY | range_rebound | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/2236_百達-KY_range_rebound_180d.png` | `data/daily_price` |
