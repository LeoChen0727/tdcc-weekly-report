...
- selected_but_routed_to_other_category_count: `148`
- not_selected_by_candidate_model_count: `310`
...
| 1808 | 潤隆 | neckline_volume_breakout | confirmed_attack | selected_but_routed_to_other_category | routed_to_pattern; strict_breakout_requires_60d_high_breakout | pattern | base_building |  |
...
| 5522 | 遠雄 | strict_60d_volume_breakout | strict_breakout | not_selected_by_candidate_model | volume breakout detected from price history but not selected by existing candidate filters |  |  | not_in_candidate_model |
