...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 7716 | 昱臺國際 | volume_expansion_watch | volume_attack | not_selected_by_candidate_model | volume breakout detected from price history but not selected by existing candidate filters |  |  | not_in_candidate_model/false_breakout_risk |
