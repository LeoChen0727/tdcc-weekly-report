...
- 產生時間：`2026-06-18 01:37:59 Asia/Taipei`
- 資料日期：`20260617`
...
- warning：`official warrant fetch produced no usable stock-level rows; preserved existing same-date raw snapshot from output/history/warrant_daily/warrant_daily_20260617.csv.`
...
- failed source=TWSE_MI_INDEX_0999P_CSV, error=HTTPSConnectionPool(host='www.twse.com.tw', port=443): Read timed out. (read timeout=1.0), url=https://www.twse.com.tw/rwd/zh/afterTrading/MI_INDEX?date=20260608&type=0999P&response=csv
- no_usable_quote_rows date=20260608, quote_rows=0; trying previous calendar date
- deadline_exceeded before quote fallback date=20260607
- official_fetch_empty_preserved_existing_raw source=output/history/warrant_daily/warrant_daily_20260617.csv date=20260617 rows=2416