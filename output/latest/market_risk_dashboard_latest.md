...
- generated_at: `2026-08-27 17:16:54 Asia/Taipei`
- data_date: `20260826`
...
| --- | --- | ---: | --- |
| institutional_fo | ok | 3 | 20260826 |
| futures_contracts | ok | 66 | 20260826 |
| options_call_put | ok | 30 | 20260826 |
| put_call_ratio | ok | 23 | 20260826 |
...
| --- | --- | --- | --- | --- | --- | --- |
| TWSE | 45,832.62 | +2.49% | +14.47% | True | True | strong_bull |
| TPEx | 395.66 | +2.82% | +18.38% | True | False | range_bound |

## 期貨選擇權部位

| indicator | value | state |
| --- | --- | --- |
| Foreign TX futures net OI | -83,654 | foreign_heavy_net_short |
| Dealer TX futures net OI | -421 |  |
| Trust TX futures net OI | +78,043 |  |
| Retail MTX net OI proxy | +944 | neutral |
| Foreign TXO call net OI | -3,301 |  |
| Foreign TXO put net OI | +21 |  |
| TXO put/call OI ratio | 103.04% | neutral |
| Taiwan VIX | 28.68 | risk_elevated |
...
- TWSE / TAIEX: strong_bull; close 45,832.62; 6M range 31,722.99-47,741.51; distance from 6M high -4.00%; above MA20=True, above MA60=True.
- TPEx / OTC: range_bound; close 395.66; 6M range 288.96-453.50; distance from 6M high -12.75%; above MA20=True, above MA60=False.

## 散戶小台 proxy

- 這是反向情緒輔助指標，以三大法人小台淨未平倉的反向 proxy 估算。
- latest_proxy_value: `+944`
- state: `neutral`
...
- 252D high / low / percentile: `44.33` / `25.68` / `10.29%`
- 504D percentile: `-`
- z-score: `-1.47`
- vix_return_5d / 10d / 20d: `-6.97%` / `-10.04%` / `-31.99%`
- TWSE / TPEx position: TWSE dist 60D high `-4%`, TPEx dist 60D high `-12.75%`
...
- 252D high / low / percentile: `16,227` / `944` / `1.59%`
- 504D percentile: `-`
