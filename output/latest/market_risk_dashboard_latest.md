...
- generated_at: `2026-06-22 22:47:45 Asia/Taipei`
- data_date: `20260622`
...
| --- | --- | ---: | --- |
| institutional_fo | ok | 3 | 20260622 |
| futures_contracts | ok | 66 | 20260622 |
| options_call_put | ok | 30 | 20260622 |
| put_call_ratio | ok | 20 | 20260622 |
| taiwan_vix | ok | 77 | 20260622 |

## 大盤指數結構

| index | close | 5d | 20d | MA20 | MA60 | regime |
| --- | --- | --- | --- | --- | --- | --- |
| TWSE | 47,741.51 | +8.09% | +12.95% | True | True | strong_bull |
| TPEx | 453.50 | +8.05% | +7.15% | True | True | strong_bull |

## 期貨選擇權部位

| indicator | value | state |
| --- | --- | --- |
| Foreign TX futures net OI | -70,290 | foreign_heavy_net_short |
| Dealer TX futures net OI | -563 |  |
| Trust TX futures net OI | +61,196 |  |
| Retail MTX net OI proxy | +3,096 | neutral |
| Foreign TXO call net OI | -251 |  |
| Foreign TXO put net OI | +4,558 |  |
| TXO put/call OI ratio | 147.65% | put_hedge_elevated |
| Taiwan VIX | 37.83 | panic_high |

## 近期總經事件日曆

- 20260617 FOMC: FOMC decision (June 16-17, 2026) (days=-5, importance=high)
- 20260625 US_PCE_personal_income: GDP (Third Estimate), Industries, Corporate Profits, State GDP, and State Personal Income, 1st Quarter 2026 (days=3, importance=high)
- 20260625 US_PCE_personal_income: Personal Income and Outlays, May 2026 (days=3, importance=high)
- 20260702 US_employment_situation: Employment Situation release schedule: June 2026 (days=10, importance=high)
- 20260707 US_trade: U.S. International Trade in Goods and Services, May 2026 (days=15, importance=medium)
- 20260714 US_CPI: CPI release schedule: June 2026 (days=22, importance=high)
- 20260729 FOMC: FOMC decision (July 28-29, 2026) (days=37, importance=high)
- 20260730 US_GDP: GDP (Advance Estimate), 2nd Quarter 2026 (days=38, importance=medium)
...
- TWSE / TAIEX: strong_bull; close 47,741.51; 6M range 28,149.64-47,741.51; distance from 6M high +0.00%; above MA20=True, above MA60=True.
- TPEx / OTC: strong_bull; close 453.50; 6M range 266.85-453.50; distance from 6M high +0.00%; above MA20=True, above MA60=True.

## 散戶小台 proxy

- 這是反向情緒輔助指標，以三大法人小台淨未平倉的反向 proxy 估算。
- latest_proxy_value: `+3,096`
- state: `neutral`
...
- 252D high / low / percentile: `43.92` / `25.68` / `78.65%`
- 504D percentile: `-`
- z-score: `0.76`
