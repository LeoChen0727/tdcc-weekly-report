...
- generated_at: `2026-06-11 16:13:06 Asia/Taipei`
- data_date: `20260611`
...
| --- | --- | ---: | --- |
| institutional_fo | ok | 3 | 20260610 |
| futures_contracts | ok | 66 | 20260610 |
| options_call_put | ok | 30 | 20260610 |
| put_call_ratio | ok | 23 | 20260610 |
...
| --- | --- | --- |
| Foreign TX futures net OI | -61,949 | foreign_heavy_net_short |
| Dealer TX futures net OI | +4,853 |  |
| Trust TX futures net OI | +54,186 |  |
| Retail MTX net OI proxy | +6,935 | neutral |
| Foreign TXO call net OI | +2,935 |  |
| Foreign TXO put net OI | +6,363 |  |
| TXO put/call OI ratio | 166.01% | put_hedge_elevated |
| Taiwan VIX | 43.92 | panic_high |
...
- 252D high / low / percentile: `43.92` / `25.68` / `100%`
- 504D percentile: `-`
- z-score: `2.26`
