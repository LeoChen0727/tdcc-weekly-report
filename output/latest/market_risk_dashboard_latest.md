...
| --- | --- | --- | --- | --- | --- | --- |
| TWSE | 45,380.52 | -2.99% | +5.17% | False | True | correction |
| TPEx | 419.90 | -5.72% | +3.15% | False | True | correction |
...
- TWSE / TAIEX: correction; close 45,380.52; 6M range 30,707.22-47,741.51; distance from 6M high -4.95%; above MA20=False, above MA60=True.
- TPEx / OTC: correction; close 419.90; 6M range 285.36-453.50; distance from 6M high -7.41%; above MA20=False, above MA60=True.
...
- TWSE / TPEx position: TWSE dist 60D high `-4.95%`, TPEx dist 60D high `-7.41%`
