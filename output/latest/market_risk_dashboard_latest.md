...
- generated_at: `2026-07-07 19:17:58 Asia/Taipei`
- data_date: `20260707`
...
| --- | --- | ---: | --- |
| institutional_fo | ok | 3 | 20260707 |
| futures_contracts | ok | 66 | 20260707 |
| options_call_put | ok | 30 | 20260707 |
| put_call_ratio | ok | 21 | 20260707 |
| taiwan_vix | ok | 66 | 20260707 |
...
| --- | --- | --- |
| Foreign TX futures net OI | -80,042 | foreign_heavy_net_short |
| Dealer TX futures net OI | +3,793 |  |
| Trust TX futures net OI | +68,187 |  |
| Retail MTX net OI proxy | +7,195 | neutral |
| Foreign TXO call net OI | +680 |  |
| Foreign TXO put net OI | +10,193 |  |
| TXO put/call OI ratio | 98.68% | neutral |
| Taiwan VIX | 38.25 | panic_high |
...
- 252D high / low / percentile: `44.01` / `25.68` / `77%`
- 504D percentile: `-`
- z-score: `0.73`
