...
- generated_at: `2026-06-23 23:07:05 Asia/Taipei`
- data_date: `20260623`
...
| --- | --- | ---: | --- |
| institutional_fo | ok | 3 | 20260623 |
| futures_contracts | ok | 66 | 20260623 |
| options_call_put | ok | 30 | 20260623 |
| put_call_ratio | ok | 21 | 20260623 |
| taiwan_vix | ok | 78 | 20260623 |
...
| TPEx | 440.81 | +2.66% | +1.34% | True | True | mild_bull |

## 期貨選擇權部位

| indicator | value | state |
| --- | --- | --- |
| Foreign TX futures net OI | -76,502 | foreign_heavy_net_short |
| Dealer TX futures net OI | +930 |  |
| Trust TX futures net OI | +60,180 |  |
| Retail MTX net OI proxy | +11,535 | retail_net_long_watch |
| Foreign TXO call net OI | +1,075 |  |
| Foreign TXO put net OI | +6,772 |  |
| TXO put/call OI ratio | 98.99% | neutral |
| Taiwan VIX | 39.32 | panic_high |
...
- 20260702 US_employment_situation: Employment Situation release schedule: June 2026 (days=9, importance=high)
- 20260707 US_trade: U.S. International Trade in Goods and Services, May 2026 (days=14, importance=medium)
- 20260714 US_CPI: CPI release schedule: June 2026 (days=21, importance=high)
- 20260729 FOMC: FOMC decision (July 28-29, 2026) (days=36, importance=high)
- 20260730 US_GDP: GDP (Advance Estimate), 2nd Quarter 2026 (days=37, importance=medium)
...
- TWSE / TAIEX: strong_bull; close 47,100.65; 6M range 28,310.47-47,741.51; distance from 6M high -1.34%; above MA20=True, above MA60=True.
- TPEx / OTC: mild_bull; close 440.81; 6M range 267.76-453.50; distance from 6M high -2.80%; above MA20=True, above MA60=True.

## 散戶小台 proxy

- 這是反向情緒輔助指標，以三大法人小台淨未平倉的反向 proxy 估算。
- latest_proxy_value: `+11,535`
...
- 252D high / low / percentile: `43.92` / `25.68` / `91.11%`
- 504D percentile: `-`
- z-score: `1.09`
- vix_return_5d / 10d / 20d: `-1.65%` / `-7%` / `15.95%`
- TWSE / TPEx position: TWSE dist 60D high `-1.34%`, TPEx dist 60D high `-2.8%`
