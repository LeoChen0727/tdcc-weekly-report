...
## Metadata
- generated_at: 2026-07-16 19:44:32 Asia/Taipei
...
## Source Dates
- market_regime_latest.csv: 20260716
- futures_options_indicators_latest.csv: 20260716
- TWSE market index: 20260716
- TPEx market index: 20260716

## Current Market Technical State
| index_id | trade_date | close | ret_5d | ret_20d | above_ma20 | above_ma60 | market_regime | risk_level |
| --- | --- | ---: | ---: | ---: | --- | --- | --- | --- |
| TWSE | 20260716 | 45,625 | -0.24% | -0.4% | False | True | high_risk | very_high_risk |
| TPEx | 20260716 | 407.01 | -3.41% | -5.4% | False | False | high_risk | very_high_risk |

## Futures Options Context
| item | value | note |
| --- | ---: | --- |
| foreign_tx_futures_net_oi | -84,453 | TX futures direction anchor |
| foreign_futures_net_oi | -506,992 | broad futures exposure only, not TX direction |
| put_call_oi_ratio_pct | 93.37% | hedging background only |
| taiwan_vix | 34.81 | volatility / hedging context only |
| retail_mtx_net_oi_proxy | 10,948 | contrarian sentiment proxy only |
