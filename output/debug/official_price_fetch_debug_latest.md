...
- 產生時間：`2026-05-26 05:10:21 Asia/Taipei`
...
- 20260526: TWSE=1235 / TPEx=5943 / Total=7178 / full_market_ok=True

## Fetch logs

- Start official daily price fetch target_date=20260526
- ===== Fetch price for date 20260526 =====
- Loaded universe rows=7178
...
- GET https://www.tpex.org.tw/www/zh-tw/afterTrading/dailyCloseQuotes?date=2026/05/26&type=EW&response=csv -> status=520, chars=959
- Trying TPEx batch source=TPEX_OLD_DAILY_JSON date=20260526
- GET https://www.tpex.org.tw/web/stock/aftertrading/daily_close_quotes/stk_quote_result.php?l=zh-tw&o=json&d=115/05/26&s=0,asc,0 -> status=520, chars=959
- Trying TPEx batch source=TPEX_OLD_DAILY_CSV date=20260526
- GET https://www.tpex.org.tw/web/stock/aftertrading/daily_close_quotes/stk_quote_result.php?l=zh-tw&o=csv&d=115/05/26&s=0,asc,0 -> status=200, chars=1459712
- TPEX_OLD_DAILY_CSV: parsed TPEx CSV rows=5943
- TPEx batch selected source=TPEX_OLD_DAILY_CSV, rows=5943
- date=20260526 twse_rows=1235 tpex_rows=5943 total_rows=7178 full_market_ok=True