...
- 產生時間：`2026-05-23 21:45:31 Asia/Taipei`
...
- 20260523: TWSE=1235 / TPEx=5684 / Total=6919 / full_market_ok=True
...
- GET https://www.tpex.org.tw/web/stock/aftertrading/daily_close_quotes/stk_quote_result.php?l=zh-tw&o=json&d=115/05/23&s=0,asc,0 -> status=520, chars=959
- Trying TPEx batch source=TPEX_OLD_DAILY_CSV date=20260523
- GET https://www.tpex.org.tw/web/stock/aftertrading/daily_close_quotes/stk_quote_result.php?l=zh-tw&o=csv&d=115/05/23&s=0,asc,0 -> status=200, chars=1447660
- TPEX_OLD_DAILY_CSV: parsed TPEx CSV rows=5684
- TPEx batch selected source=TPEX_OLD_DAILY_CSV, rows=5684
- date=20260523 twse_rows=1235 tpex_rows=5684 total_rows=6919 full_market_ok=True