...
- 主資料日期：`20260618`
- 產生時間：`2026-06-20 00:00:38 Asia/Taipei`
- 是否可產出正式每日報告：`True`
...
- 完整原因：A_優先追蹤；近幾週400張與1000張合計增加；單月營收YoY 80%~100%；累計營收YoY>=50%；近3日漲幅低於5%，股價低反應；近5日漲幅低於8%；股價貼近20MA/23EMA；尚未突破前60日高點；站上20MA/23EMA；TDCC近幾週大戶溫和增加；主流成長題材；TDCC近幾週大戶溫和增加
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
...
- 分數 / 排名：19.0 / 2.0
- 優先級：A_優先追蹤
- 連續上榜：訊號鈍化；近5日 1；近10日 3；多分類 revenue_breakout_low_response|revenue_pullback
- TDCC：大戶同步增加
- 權證：
...
- 摘要：A 優先追蹤 / 營收強 / 低反應 / 貼近均線 / 站上均線
- 完整原因：A_優先追蹤；近幾週400張與1000張同步累積；單月營收YoY 50%~80%；累計營收YoY>=30%；近3日漲幅低於5%，股價低反應；近5日漲幅低於8%；股價貼近20MA/23EMA；尚未突破前60日高點；站上20MA/23EMA；接近前高但未大幅過熱；TDCC近幾週400張與1000張同步累積；主流成長題材；TDCC近幾週400張與1000張同步累積
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
...
- 分數 / 排名：18.0 / 3.0
- 優先級：A_優先追蹤
- 連續上榜：首次上榜；近5日 1；近10日 1；多分類 pattern|revenue_breakout_low_response|revenue_pullback
- TDCC：大戶溫和增加
- 權證：
- 財報 / 事件催化：score 28 / theme 100.0/5 / revenue_good_eps_unconfirmed;low_reaction_after_catalyst;monthly_revenue_calendar;calendar_monthly_revenue_expect...
- 摘要：A 優先追蹤 / 營收強 / 低反應 / 貼近均線 / 站上均線
- 完整原因：A_優先追蹤；近幾週其中一項大戶級距增加；單月營收YoY 50%~80%；累計營收YoY>=50%；近3日漲幅低於5%，股價低反應；近5日漲幅低於8%；股價貼近20MA/23EMA；尚未突破前60日高點；站上20MA/23EMA；TDCC近幾週大戶溫和增加；主流成長題材；TDCC近幾週大戶溫和增加
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
...
- 分數 / 排名：18.0 / 7.0
- 優先級：D_降級_TDCC轉弱
- 連續上榜：訊號鈍化；近5日 1；近10日 3；多分類 pullback_rebound|range_rebound|revenue_breakout_low_response|revenue_pullback
- TDCC：大戶轉弱
- 權證：
...
- 摘要：D 降級 TDCC轉弱 / 營收強 / 近期加速 / 低反應 / 貼近均線
- 完整原因：D_降級_TDCC轉弱；近幾週其中一項大戶級距減少；單月營收YoY>=150%；累計營收YoY>=50%；單月YoY大幅高於累計YoY，近期明顯加速；近3日漲幅低於5%，股價低反應；近5日漲幅低於8%；股價貼近20MA/23EMA；尚未突破前60日高點；站上20MA/23EMA；主流成長題材；TDCC近幾週大戶籌碼轉弱；TDCC近幾週大戶籌碼轉弱
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
...
- TDCC：大戶溫和增加
- 權證：
- 財報 / 事件催化：score 18 / theme 30.9/5 / revenue_good_eps_unconfirmed;monthly_revenue_calendar;calendar_monthly_revenue_expected_window;neutral / revenue_g...
- 摘要：B 可觀察 / 營收強 / 貼近均線 / 站上均線 / 未過前高
- 完整原因：B_可觀察；近幾週400張與1000張合計增加；單月營收YoY>=150%；累計營收YoY>=50%；近5日漲幅低於8%；股價貼近20MA/23EMA；尚未突破前60日高點；站上20MA/23EMA；TDCC近幾週大戶溫和增加；一般產業；TDCC近幾週大戶溫和增加
- 精華版 PDF K 線圖來源：`local_price_redraw_first`（優先用 repo 日價資料重畫；chart_path/chart_url 僅備援）
...
- TDCC：大戶同步增加
- 權證：call_inflow / 1.0
- 財報 / 事件催化：score 28 / theme 100.0/5 / revenue_good_eps_unconfirmed;low_reaction_after_catalyst;shareholder_meeting;其他電子業;monthly_revenue_calendar;calen...
