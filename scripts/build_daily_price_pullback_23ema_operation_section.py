...
def base_row(
    ...
    if quality == "technical_strength":
        row_metric = {
            ...
            "row_metric_id": "price_pullback_23ema__technical_strength_rsi60_macd_positive",
            "row_metric_label_zh": "RSI14 >= 60 + MACD histogram > 0",
            "row_metric_matched_add_score_ids": "rsi14_ge60|macd_hist_gt0",
            "row_metric_sample_size": TECHNICAL_SAMPLE_SIZE,
            "row_metric_win_rate_zh": TECHNICAL_WIN_RATE,
            "row_metric_neutral_rate_zh": TECHNICAL_NEUTRAL_RATE,
            "row_metric_failure_rate_zh": TECHNICAL_FAILURE_RATE,
            "row_metric_avg_return_zh": TECHNICAL_AVG_RETURN,
            "row_metric_median_return_zh": "",
            "row_metric_source": "approved_operation_patterns_latest.csv:price_pullback_23ema:technical_package",
            "row_metric_selection_status": "exact_recomputed_combo_metric",
        }
    else:
        row_metric = {
