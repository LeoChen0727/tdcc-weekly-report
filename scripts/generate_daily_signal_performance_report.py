...
def build_summary(perf: pd.DataFrame) -> pd.DataFrame:
    frames = [
        ...
        stats_by(perf, ["similar_to_shihsinko_flag"], "similar_to_shihsinko_flag"),
        stats_by(perf, ["catalyst_confidence"], "catalyst_confidence"),
        stats_by(perf, ["price_reaction_level"], "price_reaction_level"),
        stats_by(perf, ["theme_strength_score"], "theme_strength_score"),
        stats_by(perf, ["catalyst_strength_score"], "catalyst_strength_score"),
        stats_by(perf, ["eps_surprise_flag"], "eps_surprise_flag"),
        stats_by(perf, ["margin_improvement_flag"], "margin_improvement_flag"),
        stats_by(perf, ["revenue_good_eps_unconfirmed_flag"], "revenue_good_eps_unconfirmed_flag"),
        stats_by(perf, ["low_reaction_after_catalyst"], "low_reaction_after_catalyst"),
        stats_by(perf, ["already_reacted_to_catalyst"], "already_reacted_to_catalyst"),
