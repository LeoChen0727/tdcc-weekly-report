...
EXPECTED_SEGMENTS = {
    ...
    "market_regime_bull",
    "market_regime_not_correction",
    "market_regime_range_or_mixed",
    "market_regime_correction",
    "market_regime_unknown",
    "low_position_le60_market_bull",
    "confirmation_signal_reference",
    "confirmation_signal_low_position_le60",
    "confirmation_signal_market_bull",
    "confirmation_signal_low_position_le60_market_bull",
    "confirmation_trigger_pullback_5ma_confirmed",
    "confirmation_trigger_next_day_break_signal_high_confirmed",
    "confirmation_trigger_next_day_continuation_confirmed",
    "confirmation_trigger_pullback_10ma_confirmed",
...
def main() -> int:
    ...
    required_text = [
        ...
        "not the initial `cond_volume_breakout` stock-screening gate",
        "not a replay of the initial volume/candle entry filter",
        "pullback_5ma_confirmed",
        "next_day_break_signal_high_confirmed",
        "next_day_continuation_confirmed",
        "pullback_10ma_confirmed",
        "Market regime is included as a research-only segmentation layer",
        "`strong_bull`",
        "`mild_bull`",
        "`range_or_mixed`",
        "`correction`",
        "do not choose between entry methods by win rate alone",
        "If the win-rate gap is small",
        "`avg_return_pct`",
        "`median_return_pct`",
        "return tradeoff",
        "locked limit-up may be part of the source attack-volume confirmation",
