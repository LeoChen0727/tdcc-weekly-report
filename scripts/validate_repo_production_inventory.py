...
PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_TARGET_ID = (
    "daily-runtime-integration-regressions-exact-target-v4"
)
...
PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_TEST = (
    PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_TEST
)
PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_BASE_SHA256_BY_PATH = {
    **PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V3_BASE_SHA256_BY_PATH,
}
PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_TARGET_SHA256_BY_PATH = {
    **PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V3_TARGET_SHA256_BY_PATH,
    "fetch_official_daily_price.py": "d9c5ea17c128763f9b41e7fe19ae181d323469678259fcd4d6735cb393d2e45c",
    "tests/test_daily_source_recovery_bundle.py": "3278127adc6675384e4f89d4247b0d1adaac04008843386f2baf58b5af234f07",
    "tests/test_market_session_calendar.py": "3fed8ab071a412eb5a98128857f940c910354f25a18cb00cc5c678bdfeb8cc15",
}
PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_PATHS = frozenset(
    PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_TARGET_SHA256_BY_PATH
)
PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_BASE_RAW_SHA256_BY_PATH = {
    **PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_BASE_SHA256_BY_PATH,
}
PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_TARGET_RAW_SHA256_BY_PATH = {
    **PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_TARGET_SHA256_BY_PATH,
}
PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_MODE_BY_PATH = {
    path: "100644"
    for path in PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_PATHS
}
PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_OBJECT_TYPE_BY_PATH = {
    path: "blob"
    for path in PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_PATHS
}
...
PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_TARGET_ID = (
    "daily-authority-snapshot-replay-concurrency-exact-target-v2"
)
PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_BASE_CONTENT_REF_SHA = (
    "a322e3c52b2556c2aec7935a49b7e7f2aa28ebbf"
)
PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_FROZEN_TARGET_REF_SHA = (
    "8c7089be0603ed7c06a19952b414d7abdcdf4ce1"
)
PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_HELPER = (
    PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_HELPER
)
PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_TEST = (
    PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_TEST
)
PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_BASE_SHA256_BY_PATH = {
    **PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_BASE_SHA256_BY_PATH,
}
PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_TARGET_SHA256_BY_PATH = {
    **PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_TARGET_SHA256_BY_PATH,
    "scripts/validate_daily_production_boundaries.py": "7193b64c5e1e66dccd579e9f9fb4b91d39419cd93aae5bfd268f91895f3190e0",
    "scripts/validate_recent_structured_source_repair_workflow.py": "c060e43930ef268fd34aff0e642d05e47a25975fde6dc2f2884e240cb4ecdc72",
    "tests/test_daily_production_boundaries.py": "b0e8de8459b42df5491f4eb207220b70c4cc50990d26e48d230c926ad1539c86",
    "tests/test_validate_recent_structured_source_repair_workflow.py": "6290786573960255a97a7576684f4ce6410a5f215aa22899e11daa7df7b7d06a",
}
PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_PATHS = frozenset(
    PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_TARGET_SHA256_BY_PATH
)
PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_BASE_RAW_SHA256_BY_PATH = {
    **PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_BASE_SHA256_BY_PATH,
}
PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_TARGET_RAW_SHA256_BY_PATH = {
    **PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_TARGET_SHA256_BY_PATH,
}
PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_MODE_BY_PATH = {
    path: "100644" for path in PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_PATHS
}
PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_OBJECT_TYPE_BY_PATH = {
    path: "blob" for path in PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_PATHS
}
PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_CHANGE_STATUS_BY_PATH = {
    path: "M" for path in PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_PATHS
}
...
def pr_safe_daily_authority_containment_target_profiles(
    ...
    profiles = (
        (
            ...
            PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_BASE_SHA256_BY_PATH,
            PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_TARGET_SHA256_BY_PATH,
            PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_PATHS,
        ),
        (
            PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_TARGET_ID,
            PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_BASE_CONTENT_REF_SHA,
        ...
        (
            ...
            PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_BASE_SHA256_BY_PATH,
            PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_TARGET_SHA256_BY_PATH,
            PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V4_PATHS,
        ),
        (
            PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V3_TARGET_ID,
            PR_SAFE_DAILY_RUNTIME_INTEGRATION_REGRESSIONS_V3_BASE_CONTENT_REF_SHA,
...
def daily_runtime_integration_regressions_identity_contract(
    ...
    if target_id == PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_TARGET_ID:
        return (
            PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_BASE_RAW_SHA256_BY_PATH,
            PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_TARGET_RAW_SHA256_BY_PATH,
            PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_MODE_BY_PATH,
...
def daily_authority_containment_change_status_contract(
    ...
    if target_id == PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_TARGET_ID:
        return PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_V2_CHANGE_STATUS_BY_PATH
    if target_id == PR_SAFE_DAILY_AUTHORITY_SNAPSHOT_REPLAY_TARGET_ID:
