...
PRICE_PULLBACK_PDF_OPERATION_DESCRIPTION_ZH = (
    "買入：本表股票為23EMA回檔模型通過候選，隔日開盤買入。"
    "賣出：收盤突破訊號日前20日高點後，隔日開盤賣出。"
    "停損：收盤連續4天低於MA20/EMA23較低者的4%，隔日開盤停損。"
    "基礎模型績效：勝率66.03% / 和局5.60% / 敗率28.36% / 平均報酬+2.90%。"
    "技術強勢組合績效：勝率75.54% / 和局3.52% / 敗率20.95% / 平均報酬+2.96%。"
    "勝：D+20內先觸發收盤突破訊號日前20日高點，且停損未先觸發。"
    "和：D+20內沒有賣出或停損，且D+20收盤報酬大於等於0%。"
    "敗：停損先觸發，或D+20內沒有賣出/停損但D+20收盤報酬小於0%。"
)
