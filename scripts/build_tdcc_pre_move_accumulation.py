...
def write_markdown(df: pd.DataFrame) -> None:
    ...
    lines = [
        ...
        "## 本週潛伏吸籌候選股 Top 20",
        "",
        markdown_table(top, ["abm_rank", "code", "name", "primary_theme", "abm_score", "setup_type", "all_threshold_streak_weeks", "tdcc_800_streak_weeks", "tdcc_1000_streak_weeks", "price_return_5d", "price_return_20d", "distance_ma20_pct", "price_range_20d_pct", "volume_ratio_20d", "abm_reason"], 20),
        "",
        "## A/B/C 分級",
        "",
        markdown_table(df.sort_values(["priority_group", "abm_score"], ascending=[True, False]), ["priority_group", "abm_rank", "code", "name", "abm_score", "setup_type", "price_return_20d", "distance_ma20_pct", "abm_reason"], 80),
        "",
        "## 已發動 / 過熱名單",
        "",
        markdown_table(active, ["abm_rank", "code", "name", "primary_theme", "abm_score", "setup_type", "price_return_5d", "price_return_20d", "distance_ma20_pct", "volume_ratio_5d", "abm_reason"], 30),
        "",
        "## 族群潛伏廣度",
        "",
