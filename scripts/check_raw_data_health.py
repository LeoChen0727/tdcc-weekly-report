...
CORE_PATHS = [
    ...
    ("daily_candidate_decision", Path("output/latest/daily_candidate_decision_latest.csv")),
    ("daily_candidate_decision_md", Path("output/latest/daily_candidate_decision_latest.md")),
    ("daily_candidate_decision_packet", Path("output/latest/daily_candidate_decision_chatgpt_packet_latest.md")),
