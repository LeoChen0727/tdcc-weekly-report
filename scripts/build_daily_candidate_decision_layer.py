...
def apply_authoritative_taxonomy(candidates: pd.DataFrame) -> pd.DataFrame:
    ...
    tax = tax[[col for col in tax_cols if col in tax.columns]].rename(
        columns={
            ...
            "report_line_memberships": "taxonomy_report_line_memberships",
            "mainstream_report_eligible": "taxonomy_mainstream_report_eligible",
            "non_mainstream_report_eligible": "taxonomy_non_mainstream_report_eligible",
            "dual_report_membership_flag": "taxonomy_dual_report_membership_flag",
            "report_line_membership_note": "taxonomy_report_line_membership_note",
...
def build_decision(candidates: pd.DataFrame, main_date: str) -> pd.DataFrame:
    ...
    for idx, row in candidates.iterrows():
        ...
        base = {
            ...
            "report_line_memberships": first_text(row, ["taxonomy_report_line_memberships", "report_line_memberships"]),
            "mainstream_report_eligible": first_text(row, ["taxonomy_mainstream_report_eligible", "mainstream_report_eligible"]),
            "non_mainstream_report_eligible": first_text(row, ["taxonomy_non_mainstream_report_eligible", "non_mainstream_report_eligible"]),
            "dual_report_membership_flag": first_text(row, ["taxonomy_dual_report_membership_flag", "dual_report_membership_flag"]),
            "report_line_membership_note": first_text(row, ["taxonomy_report_line_membership_note", "report_line_membership_note"]),
