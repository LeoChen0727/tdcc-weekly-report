...
CASE_STOCK_ID = "2484"
CASE_STOCK_NAME = "希華"
CASE_DATES = ["20260520", "20260521", "20260522", "20260525"]
...
def build_rows() -> tuple[pd.DataFrame, dict[str, Any]]:
    ...
    validation = {
        ...
        "first_trigger_date": safe_text(prewarning["case_date"].iloc[0]) if not prewarning.empty else "",
...
def render_markdown(df: pd.DataFrame, validation: dict[str, Any]) -> str:
    lines = [
        ...
        f"- first_trigger_date: `{validation['first_trigger_date']}`",
