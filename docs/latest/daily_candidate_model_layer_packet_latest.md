...
| price_pullback_23ema                | 股價回檔模型              | mainstream      |     247 |
| price_pullback_23ema                | 股價回檔模型              | non_mainstream  |     135 |
| pullback_short_reclaim              | 回檔後短線轉強模型           | mainstream      |      65 |
| pullback_short_reclaim              | 回檔後短線轉強模型           | non_mainstream  |      24 |
| revenue_unreacted_range             | 營收爆發但股價尚未反應模型       | mainstream      |     148 |
...
| tdcc_stealth_accumulation           | TDCC潛伏吸籌模型          | mainstream      |     120 |
| tdcc_stealth_accumulation           | TDCC潛伏吸籌模型          | non_mainstream  |      82 |
| volume_range_breakout               | 帶量突破模型              | mainstream      |      69 |
| volume_range_breakout               | 帶量突破模型              | non_mainstream  |      42 |
| w_bottom_right_side                 | W底右側模型              | mainstream      |      71 |
| w_bottom_right_side                 | W底右側模型              | non_mainstream  |      20 |

## Group Rotation

|   signal_date | theme   |   stock_count |   volume_expansion_3x_count |   volume_expansion_ratio | leader_1   | leader_2   | leader_3   | interpretation     |
|--------------:|:--------|--------------:|----------------------------:|-------------------------:|:-----------|:-----------|:-----------|:-------------------|
|      20260529 | 汽車工業    |            23 |                           8 |                   0.3478 | 1524 耿鼎    | 1563 巧新    | 6605 帝寶    | 族群資金輪動觀察；不是個股買進模型。 |
