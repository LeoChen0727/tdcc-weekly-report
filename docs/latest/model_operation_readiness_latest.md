...
- generated_at: `2026-06-30 11:37:01 Asia/Taipei`
...
| price_pullback_23ema | production_proxy | operation_candidate_v1_pending_exact_row_parity | blocked_exact_daily_row_parity | False | pending_exact_daily_row_parity | price_pullback_23ema_prev20_breakout_stop_v1 | price_pullback_23ema_operation_candidate_v1_20260630 | False | no_operation_directive | blocked_exact_daily_row_parity | blocked_exact_daily_row_parity | exact daily candidate row parity still pending; operation candidate evidence selected, but production operation guidance remains blocked | price_pullback_23ema 已選出 operation candidate v1：先有 production proxy 訊號，且同日符合大戶高門檻增加與 20 日漲幅 0% 到 25%；買點為次日開盤，勝利為 D+20 前盤中突破訊號日前 20 日高點，失敗為連續 4 日收盤低於 MA20/EMA23 較低者 4%。目前仍缺 exact daily candidate row parity，所以不得產生 production 買進、賣出、停損或排名操作建議。 |
