...
- generated_at: `2026-06-30 15:46:26 Asia/Taipei`
...
| operation_candidate_v1_pending_exact_row_parity | 1 |
...
| blocked_exact_daily_row_parity | 1 |
...
| price_pullback_23ema | production_proxy | operation_candidate_v1_pending_exact_row_parity | blocked_exact_daily_row_parity | False | pending_exact_daily_row_parity | price_pullback_23ema_prev20_breakout_stop_v1 | price_pullback_23ema_operation_candidate_v1_20260630 | False | no_operation_directive | blocked_exact_daily_row_parity | blocked_exact_daily_row_parity | exact daily row parity audit failing: snapshots=10, latest_snapshot=20260630, published_not_proxy=118, proxy_not_published=11119, missing_research_dates=1, gap_drivers=missing_research_frame_date,research_full_universe_proxy_exceeds_daily_candidate_publication_scope | price_pullback_23ema 已選出 operation candidate v1：先有 production proxy 訊號，且同日符合大戶高門檻增加與 20 日漲幅 0% 到 25%；買點為次日開盤，勝利為 D+20 前盤中突破訊號日前 20 日高點，失敗為連續 4 日收盤低於 MA20/EMA23 較低者 4%。目前仍缺 exact daily candidate row parity，daily row parity audit 仍未通過：共 10 個 published snapshots，published 不在 research proxy 的股票數合計 118，research proxy 未出現在 published snapshot 的股票數合計 11119，缺 research frame 日期 1 個。目前主要差異需用 dated all_candidates/source-row candidate universe replay 釐清，不能把 full-universe research proxy 視為 production baseline。所以不得產生 production 買進、賣出、停損或排名操作建議。 |
