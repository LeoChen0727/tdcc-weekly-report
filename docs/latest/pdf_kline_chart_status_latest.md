...
|---|---|---|---|---|---|
| 4976 | 佳凌 | true_breakout | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/4976_佳凌_true_breakout_126d.png` | `data/daily_price` |
...
| 3019 | 亞光 | true_breakout | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/3019_亞光_true_breakout_126d.png` | `data/daily_price` |
| 6668 | 中揚光 | true_breakout | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/6668_中揚光_true_breakout_126d.png` | `data/daily_price` |
| 3044 | 健鼎 | true_breakout | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/3044_健鼎_true_breakout_126d.png` | `data/daily_price` |
| 2340 | 台亞 | range_rebound | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/2340_台亞_range_rebound_126d.png` | `data/daily_price` |
...
| 2467 | 志聖 | revenue_pullback | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/2467_志聖_revenue_pullback_126d.png` | `data/daily_price` |
...
| 6239 | 力成 | pullback_rebound | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/6239_力成_pullback_rebound_126d.png` | `data/daily_price` |
