...
| 0061 | 元大寶滬深 | range_rebound | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/0061_元大寶滬深_range_rebound_126d.png` | `data/daily_price` |
| 1310 | 台苯 | range_rebound | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/1310_台苯_range_rebound_126d.png` | `data/daily_price` |
| 1314 | 中石化 | range_rebound | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/1314_中石化_range_rebound_126d.png` | `data/daily_price` |
| 1515 | 力山 | range_rebound | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/1515_力山_range_rebound_126d.png` | `data/daily_price` |
| 1709 | 和益 | range_rebound | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/1709_和益_range_rebound_126d.png` | `data/daily_price` |
