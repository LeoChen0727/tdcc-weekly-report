...
| 4306 | 炎洲 | true_breakout | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/4306_炎洲_true_breakout_126d.png` | `data/daily_price` |
| 2537 | 聯上發 | true_breakout | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/2537_聯上發_true_breakout_126d.png` | `data/daily_price` |
| 5522 | 遠雄 | true_breakout | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/5522_遠雄_true_breakout_126d.png` | `data/daily_price` |
...
| 2327 | 國巨* | range_rebound | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/2327_國巨__range_rebound_126d.png` | `data/daily_price` |
| 2834 | 臺企銀 | range_rebound | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/2834_臺企銀_range_rebound_126d.png` | `data/daily_price` |
...
| 9939 | 宏全 | pattern | redrawn_from_local_price_data | `output/latest/charts/pdf_kline/9939_宏全_pattern_126d.png` | `data/daily_price` |