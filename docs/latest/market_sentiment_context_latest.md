...
- generated_at: `2026-07-17 23:44:59 Asia/Taipei`
- date: `20260717`
...
| --- | ---: | ---: | ---: | ---: | --- | --- |
| TWSE | 42,671 | -10.62% | -10.62% | -10.62% | False | False |
...
- foreign_tx_futures_net_oi: `-86,189`
- foreign_futures_net_oi: `-490,521` (whole futures exposure background only, not TX direction)
- put_call_oi_ratio_pct: `92.94%`
