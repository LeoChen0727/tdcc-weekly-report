...
- generated_at: `2026-06-05 02:33:55 Asia/Taipei`
- date: `20260603`
...
- foreign_tx_futures_net_oi: `-69,476`
- foreign_futures_net_oi: `-656,037` (whole futures exposure background only, not TX direction)
- put_call_oi_ratio_pct: `140.41%`
