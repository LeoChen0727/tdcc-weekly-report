...
- generated_at: `2026-07-14 06:33:14 Asia/Taipei`
- date: `20260713`
...
| --- | ---: | ---: | ---: | ---: | --- | --- |
| TWSE | 45,381 | -4.95% | -4.95% | -4.95% | False | True |
| TPEx | 419.9 | -7.41% | -7.41% | -7.41% | False | True |
...
- foreign_futures_net_oi: `-561,082` (whole futures exposure background only, not TX direction)
- put_call_oi_ratio_pct: `124.42%`
