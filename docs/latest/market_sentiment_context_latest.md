...
- generated_at: `2026-09-10 19:48:34 Asia/Taipei`
- date: `20260910`
...
| --- | ---: | ---: | ---: | ---: | --- | --- |
| TWSE | 46,940 | -0.82% | -1.68% | -1.68% | True | True |
| TPEx | 405.24 | -1.35% | -10.64% | -10.64% | True | True |

## Combined Sentiment Interpretation

- combined_sentiment_interpretation: `sentiment_mixed_observe`
- sentiment_warning_level: `low`
- foreign_tx_futures_net_oi: `-83,918`
- foreign_futures_net_oi: `-542,211` (whole futures exposure background only, not TX direction)
- put_call_oi_ratio_pct: `82.67%`
