...
- generated_at: `2026-09-21 19:50:02 Asia/Taipei`
- date: `20260921`
...
| --- | ---: | ---: | ---: | ---: | --- | --- |
| TWSE | 47,719 | 0% | 0% | -0.05% | True | True |
...
- foreign_tx_futures_net_oi: `-74,081`
- foreign_futures_net_oi: `-419,127` (whole futures exposure background only, not TX direction)
- put_call_oi_ratio_pct: `96.2%`
