...
- generated_at: `2026-06-17 05:51:57 Asia/Taipei`
- date: `20260616`
...
- foreign_tx_futures_net_oi: `-69,847`
- foreign_futures_net_oi: `-562,599` (whole futures exposure background only, not TX direction)
- put_call_oi_ratio_pct: `164.48%`
