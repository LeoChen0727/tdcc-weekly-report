...
- generated_at: `2026-07-01 20:47:59 Asia/Taipei`
- date: `20260701`
...
- foreign_tx_futures_net_oi: `-84,168`
- foreign_futures_net_oi: `-576,307` (whole futures exposure background only, not TX direction)
- put_call_oi_ratio_pct: `142.03%`
