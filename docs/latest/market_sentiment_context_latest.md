...
- generated_at: `2026-06-26 00:13:18 Asia/Taipei`
- date: `20260624`
...
- foreign_tx_futures_net_oi: `-81,051`
- foreign_futures_net_oi: `-594,327` (whole futures exposure background only, not TX direction)
- put_call_oi_ratio_pct: `114.57%`
