...
|---|---|---:|---|---|
| twse_ex_right_ex_dividend | ok | 117 | https://www.twse.com.tw/rwd/zh/exRight/TWT48U?response=json |  |
| twse_shareholder_meeting_from_dividend_distribution | ok | 548 | https://openapi.twse.com.tw/v1/opendata/t187ap45_L | TWSE-listed shareholder meeting dates parsed from official OpenAPI t187ap45_L when available. |
| monthly_revenue_expected_window | rule_based_expected_window | 335 | https://mops.twse.com.tw/mops/web/t05st10_ifrs | Expected monthly revenue publication window generated for tracked stocks; not a confirmed company catalyst. |
