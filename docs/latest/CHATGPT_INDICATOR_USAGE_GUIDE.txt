...
- generated_at: `2026-06-17 11:48:54 UTC`
...
| Warrant flow | output/latest/warrant_flow_by_stock_latest.csv | warrant_flow_signal, warrant_flow_score, warrant_flow_warning | 無明確權證訊號=353; 認購流入=57; 認購強流入=21; 認購/認售結構偏多=12; 認售流入=7; 多空混合=1 | Auxiliary only. Do not make warrant-only conclusions. |
