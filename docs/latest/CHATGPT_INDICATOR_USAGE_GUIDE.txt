...
- generated_at: `2026-05-29 13:39:09 台北標準時間`
...
| Daily candidate decision | output/latest/daily_candidate_decision_latest.csv | decision_priority, decision_score, pattern_mapped_category, downgrade_flags, risk_tags, why_selected, why_downgraded, next_confirmation | D_risk_downgrade=357; C_watch_only=255; B_confirm_needed=57; A_priority_watch=7 | Primary source for daily candidate ranking and downgrade. |
...
| Non-revenue momentum watch | output/latest/non_revenue_momentum_watch_latest.csv | non_revenue_momentum_type, revenue_confirmation_status, theme_final_status, theme_volume_attack_status, volume_breakout_type, next_confirmation | rows=91 / D_overheated_or_failed_risk=87; A_fund_flow_confirmed_revenue_unconfirmed=2; C_hot_money_watch=2 | Specialty overlay for stocks moving on price/theme/fund flow before revenue/EPS confirmation. It is not a seventh core category. |
...
| Volume attack theme layer | output/latest/volume_attack_theme_layer_latest.csv | theme_final_status, theme_volume_attack_status, leader_stock, range/strict/watch counts, interpretation | overheated_volume_theme=11; non_mainstream_volume_watch=8; single_stock_volume_attack=1; theme_status_missing=1 / stocks=215 | Authoritative mainstream/non-mainstream split for volume-attack sections. Do not show only the theme name. |
