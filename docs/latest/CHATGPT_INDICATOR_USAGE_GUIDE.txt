...
- generated_at: `2026-06-17 20:42:55 UTC`
...
| Non-revenue momentum watch | output/latest/non_revenue_momentum_watch_latest.csv | non_revenue_momentum_type, revenue_confirmation_status, theme_final_status, theme_volume_attack_status, volume_breakout_type, next_confirmation | rows=38 / D_overheated_or_failed_risk=18; C_hot_money_watch=17; A_fund_flow_confirmed_revenue_unconfirmed=3 | Specialty overlay for stocks moving on price/theme/fund flow before revenue/EPS confirmation. It is not a seventh core category. |
...
| Warrant flow | output/latest/warrant_flow_by_stock_latest.csv | warrant_flow_signal, warrant_flow_score, warrant_flow_warning | 無明確權證訊號=340; 認購流入=61; 認購強流入=23; 認購/認售結構偏多=19; 認售流入=7; 多空混合=1 | Auxiliary only. Do not make warrant-only conclusions. |
