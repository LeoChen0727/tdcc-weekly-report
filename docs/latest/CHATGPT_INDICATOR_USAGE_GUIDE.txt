...
- generated_at: `2026-06-17 00:06:02 UTC`
...
| Repeat appearance | output/latest/candidate_repeat_appearance_latest.csv | repeat_appear_label, consecutive_appear_days_any_category, appear_count_5d/10d/20d | stale_signal=207; repeated_but_no_breakout=49; continued_overheated=26; continued_2_3d=23; first_seen=13; continued_many_days=12 | Use as persistence/staleness signal, never as a standalone upgrade. |
...
| Daily theme status history | output/history/daily_signals/daily_theme_status_history.csv | signal_date, stock_id, theme_final_status, theme_status_group, theme_volume_attack_status, candidate_source_type | mainstream_overheated=175; mainstream_supported=156; non_mainstream=2 / rows=333 | Use for no-lookahead mainstream/non-mainstream backtests; do not use today's theme label for older signal dates. |
