...
- generated_at: `2026-09-03 19:51:12 Asia/Taipei`
- status: `pass`
- schema_only: `False`

| file | exists | rows | size_bytes |
|---|---:|---:|---:|
| company_event_calendar | True | 4867 | 2220345 |
| macro_event_calendar | True | 53 | 18187 |
| upcoming_company_calendar | True | 914 | 410818 |
| upcoming_macro_calendar | True | 18 | 6346 |
