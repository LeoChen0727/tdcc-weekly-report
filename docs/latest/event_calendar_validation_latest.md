...
- generated_at: `2026-09-04 19:52:11 Asia/Taipei`
- status: `pass`
- schema_only: `False`

| file | exists | rows | size_bytes |
|---|---:|---:|---:|
| company_event_calendar | True | 4870 | 2221692 |
| macro_event_calendar | True | 53 | 18186 |
| upcoming_company_calendar | True | 900 | 406789 |
| upcoming_macro_calendar | True | 18 | 6343 |
