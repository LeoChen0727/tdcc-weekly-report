...
- generated_at: `2026-07-01 21:36:15 Asia/Taipei`
...
| quarterly_catalyst | `data/fundamental_catalysts/quarterly_catalyst.csv` | 891 |
...
|---|---|---:|---:|---|---|
| TWSE monthly revenue OpenAPI | ok | 1082 | 319 | https://openapi.twse.com.tw/v1/opendata/t187ap05_L | Official monthly revenue rows are stored as fundamental source rows with EPS/margin fields blank. They can flag revenue_good_eps_unconfirmed only; they are not EPS confirmation. |
...
| TPEX material information OpenAPI | ok | 151 | 23 | https://www.tpex.org.tw/openapi/v1/mopsfin_t187ap04_O | Official material-information rows are filtered to tracked stocks. Only objective order/customer/capacity/production/certification keywords become evidence event types; other rows stay material_information context. |
