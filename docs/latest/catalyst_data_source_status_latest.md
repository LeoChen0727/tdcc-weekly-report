...
- generated_at: `2026-06-23 08:05:48 Asia/Taipei`
...
| quarterly_catalyst | `data/fundamental_catalysts/quarterly_catalyst.csv` | 778 |
| event_catalyst_log | `data/event_catalysts/event_catalyst_log.csv` | 726 |

## External Source Status

| source | status | rows | matched_tracked_rows | url | note |
|---|---|---:|---:|---|---|
| TWSE monthly revenue OpenAPI | ok | 1082 | 393 | https://openapi.twse.com.tw/v1/opendata/t187ap05_L | Official monthly revenue rows are stored as fundamental source rows with EPS/margin fields blank. They can flag revenue_good_eps_unconfirmed only; they are not EPS confirmation. |
| TPEX monthly revenue OpenAPI | ok | 890 | 186 | https://www.tpex.org.tw/openapi/v1/mopsfin_t187ap05_O | Official monthly revenue rows are stored as fundamental source rows with EPS/margin fields blank. They can flag revenue_good_eps_unconfirmed only; they are not EPS confirmation. |
| TWSE material information OpenAPI | ok | 191 | 80 | https://openapi.twse.com.tw/v1/opendata/t187ap04_L | Official material-information rows are filtered to tracked stocks. Only objective order/customer/capacity/production/certification keywords become evidence event types; other rows stay material_information context. |
