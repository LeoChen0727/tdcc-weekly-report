...
- generated_at: `2026-07-03 19:39:11 Asia/Taipei`
...
| quarterly_catalyst | `data/fundamental_catalysts/quarterly_catalyst.csv` | 931 |
| event_catalyst_log | `data/event_catalysts/event_catalyst_log.csv` | 1807 |
...
| TPEX material information OpenAPI | ok | 48 | 9 | https://www.tpex.org.tw/openapi/v1/mopsfin_t187ap04_O | Official material-information rows are filtered to tracked stocks. Only objective order/customer/capacity/production/certification keywords become evidence event types; other rows stay material_information context. |
