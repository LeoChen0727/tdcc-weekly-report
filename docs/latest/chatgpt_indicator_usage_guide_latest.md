...
- generated_at: `2026-06-16 10:26:37 UTC`
...
| Warrant flow | output/latest/warrant_flow_by_stock_latest.csv | warrant_flow_signal, warrant_flow_score, warrant_flow_warning | 無明確權證訊號=369; 認購流入=48; 認購強流入=34 | Auxiliary only. Do not make warrant-only conclusions. |
