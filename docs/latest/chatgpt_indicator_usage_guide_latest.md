...
- generated_at: `2026-06-18 17:21:16 UTC`
...
| Non-revenue momentum watch | output/latest/non_revenue_momentum_watch_latest.csv | non_revenue_momentum_type, revenue_confirmation_status, theme_final_status, theme_volume_attack_status, volume_breakout_type, next_confirmation | rows=82 / D_overheated_or_failed_risk=64; C_hot_money_watch=16; A_fund_flow_confirmed_revenue_unconfirmed=2 | Specialty overlay for stocks moving on price/theme/fund flow before revenue/EPS confirmation. It is not a seventh core category. |
