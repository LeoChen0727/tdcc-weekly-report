...
- generated_at: `2026-06-18 05:09:03 UTC`
...
| Daily candidate model signals for report | output/latest/daily_candidate_model_signals_for_report_latest.csv | model_id, model_name_zh, model_score, model_rank, display_rank, score_components, risk_penalty_tags, risk_tags, next_confirmation | price_pullback_23ema=145; pullback_short_reclaim=93; hot_theme_pullback=38; tdcc_short_term_continuation_d5_d10=18; volume_range_breakout=14; platform_strengthening=2; w_bottom_right_side=2 | Primary source for daily PDF/packet model rows, scores, ranks, risks, and next confirmations. |
| Repeat appearance | output/latest/candidate_repeat_appearance_latest.csv | repeat_appear_label, consecutive_appear_days_any_category, appear_count_5d/10d/20d | stale_signal=201; repeated_but_no_breakout=43; continued_overheated=34; continued_many_days=16; first_seen=13; continued_2_3d=12 | Use as persistence/staleness signal, never as a standalone upgrade. |
...
| Daily theme status history | output/history/daily_signals/daily_theme_status_history.csv | signal_date, stock_id, theme_final_status, theme_status_group, theme_volume_attack_status, candidate_source_type | mainstream_overheated=319; non_mainstream=1 / rows=320 | Use for no-lookahead mainstream/non-mainstream backtests; do not use today's theme label for older signal dates. |
...
| file | status | rows |
| --- | --- | --- |
| daily_candidate_model_signals_for_report_latest.csv | ready | 312 |
