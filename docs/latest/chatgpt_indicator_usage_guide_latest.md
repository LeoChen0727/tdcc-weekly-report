...
- generated_at: `2026-06-18 21:42:05 UTC`
...
| Warrant flow | output/latest/warrant_flow_by_stock_latest.csv | warrant_flow_signal, warrant_flow_score, warrant_flow_warning | 無明確權證訊號=304; 認購流入=89; 認購強流入=58 | Auxiliary only. Do not make warrant-only conclusions. |
