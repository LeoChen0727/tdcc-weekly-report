...
- Mature operation stock rows audited: `406`.
- Unique stock lifecycle rows after removing highlight/full view duplication: `203`.
- Ready row-level metrics: `66`; explicit unavailable rows: `340`.
...
| mature_model | `volume_range_breakout_v2_high_position_volume_attack` | 2 | 1 | 2 | 0 | single_add_score | pass_ready_rows_use_formal_row_metric | pass_exact_recomputed_combo_metrics_match_research_source / pass_exact_combo_or_best_single_fallback_policy | adapter_contract_ready_pdf_packet_consumers_integrated | none |
...
| mature_model | `price_pullback_23ema` | 322 | 161 | 64 | 258 | exact_combo | pass_ready_rows_use_formal_row_metric | pass_exact_package_metric_required_for_multi_feature_technical_strength / pass_improves_win_and_avg_vs_baseline | adapter_contract_ready_pdf_packet_consumers_integrated | none |
