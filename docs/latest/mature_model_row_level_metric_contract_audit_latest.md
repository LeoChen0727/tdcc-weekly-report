...
- Mature operation stock rows audited: `310`.
- Unique stock lifecycle rows after removing highlight/full view duplication: `155`.
- Ready row-level metrics: `184`; explicit unavailable rows: `126`.
...
| --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- | --- | --- |
| mature_model | `volume_range_breakout_v2_low_position_volume_attack` | 4 | 2 | 0 | 4 | no_current_formal_row_metric | pass_explicit_unavailable_no_baseline_substitution | not_available_unvalidated_ranking_score_components / not_applicable_no_approved_combo_metric | adapter_contract_ready_pdf_packet_consumers_integrated | none |
| mature_model | `volume_range_breakout_v2_mid_position_momentum_attack` | 2 | 1 | 0 | 2 | no_current_formal_row_metric | pass_explicit_unavailable_no_baseline_substitution | not_available_unvalidated_ranking_score_components / not_applicable_no_approved_combo_metric | adapter_contract_ready_pdf_packet_consumers_integrated | none |
...
| mature_model | `price_pullback_23ema` | 280 | 140 | 184 | 96 | exact_combo | pass_ready_rows_use_formal_row_metric | pass_exact_package_metric_required_for_multi_feature_technical_strength / pass_improves_win_and_avg_vs_baseline | adapter_contract_ready_pdf_packet_consumers_integrated | none |
