...
- audit_version: `v2`
- generated_at: `2026-07-11 12:09:09 Asia/Taipei`
...
- Mature operation stock rows audited: `366`.
- Unique stock lifecycle rows after removing highlight/full view duplication: `183`.
- Ready row-level metrics: `62`; explicit unavailable rows: `304`.
