...
- Mature operation stock rows audited: `658`.
- Unique stock lifecycle rows after removing highlight/full view duplication: `329`.
- Ready row-level metrics: `154`; explicit unavailable rows: `504`.
