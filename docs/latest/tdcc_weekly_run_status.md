...
- generated_at: `2026-06-28 05:55:09 Asia/Taipei`
- github_run: https://github.com/LeoChen0727/tdcc-weekly-report/actions/runs/28302799594
- commit: `3c6def5dab8c24301a7ee0002cb0e71a5baa178d`
...
| `output/latest/tdcc_signal_performance_latest.md` | yes | 506 |
...
| `output/latest/tdcc_chatgpt_tracking_packet_latest.md` | yes | 499 |
| `output/latest/tdcc_weekly_increase_ranking_latest.md` | yes | 59 |
| `output/latest/tdcc_weekly_increase_ranking_latest.csv` | yes | 413 |
...
| `output/latest/tdcc_weekly_candidate_highlight_latest.pdf` | yes | 954 |
| `output/latest/tdcc_weekly_candidate_full_latest.pdf` | yes | 1243 |
...
| `output/history/tdcc_signals/tdcc_signal_log.csv` | yes | 706 |
| `output/history/tdcc_signals/tdcc_signal_performance.csv` | yes | 706 |
